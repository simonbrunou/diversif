...
## Corpus Check
- 453 files · ~367,269 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4284 nodes · 8193 edges · 156 communities (142 shown, 14 thin omitted)
...
Cohesion: 0.01
Nodes (283): addSymptomNotePlaceholder(), addSymptomObservedAt(), addSymptomSubmit(), allergenDialogBadgeFromMonths(), allergenDialogSeverityMajor(), allergenDialogWhyEarlyTitle(), allergenPassportFadingHint, allergenPassportSectionOther (+275 more)

### Community 2 - "i18n Messages (errors+log+landing)"
Cohesion: 0.01
Nodes (213): addSymptomLabel(), addSymptomSeveritySevereSrPrefix(), addSymptomSubmit(), allergenDialogClose(), allergenDialogFirstSignsTitle(), allergenDialogHowToOfferTitle(), allergenDialogSevereSignsTitle(), allergenDialogSeverityMajor() (+205 more)

### Community 3 - "Page Loaders & Form Actions"
Cohesion: 0.01
Nodes (212): addSymptomLabel(), addSymptomNote(), addSymptomSeveritySevereSrPrefix(), addSymptomTitle(), allergenDialogClose(), allergenDialogFirstSignsTitle(), allergenDialogHowToOfferTitle(), allergenDialogSevereSignsTitle() (+204 more)

### Community 4 - "Test Fixtures & Setup Helpers"
Cohesion: 0.01
Nodes (282): addSymptomNote(), addSymptomNotePlaceholder(), addSymptomObservedAt(), addSymptomTitle(), allergenDialogBadgeFromMonths(), allergenDialogSourcesTitle(), allergenPassportFadingHint, allergenPassportSectionOther (+274 more)

### Community 5 - "Branding, App Shell & PWA Manifest"
Cohesion: 0.07
Nodes (58): load(), foodEntries, foods, makeDeleteEvent(), makeFormEvent(), setup(), loadFor(), setup() (+50 more)

### Community 6 - "Architecture Patterns & Conventions"
Cohesion: 0.06
Nodes (54): db, drizzleDb, pool, sqlite, Membership, loadEntry(), schema, load() (+46 more)

### Community 7 - "Auth Routes & i18n Routing"
Cohesion: 0.05
Nodes (47): seed(), Session, User, actions, load(), seed(), seed(), seedTestUser() (+39 more)
...
Cohesion: 0.08
Nodes (49): load(), VALID_THEMES, Passkey, PASSKEY_AUTOFILL_OPTIONS_LIMIT, PASSKEY_OPTIONS_LIMIT, POST(), actions, deleteSchema (+41 more)

### Community 10 - "Offline Log Queue (IndexedDB)"
Cohesion: 0.06
Nodes (11): $lib/i18n, $lib/paraglide/messages, $lib/server/guidance/allergen-status, $lib/utils/age, $lib/utils/localized-href, $lib/utils/milestones, $lib/utils/suggest, $app/state (+3 more)
...
Cohesion: 0.08
Nodes (9): filtered, baseClass, $lib/paraglide/runtime, $lib/utils/categories, $lib/utils/cn, $lib/utils/reactions, $lib/utils/search, $lib/utils/texture-labels (+1 more)
...
Cohesion: 0.17
Nodes (5): sources, $lib/content/guidance, $lib/content/sources, $lib/seo, $lib/utils/allergens
...
Cohesion: 0.14
Nodes (19): execRows(), Executor, actions, AllergenSummary, load(), dismissReminder(), loadDismissals(), ttlForReminderKey() (+11 more)
...
Cohesion: 0.09
Nodes (16): purgeClientState(), ActionError, ActionFailure, ActionRedirect, ActionResult, clear(), deleteRow(), emit() (+8 more)
...
Cohesion: 0.14
Nodes (22): SEVERE, Severity, severityOf(), SYMPTOM_LABELS, SymptomLabel, WARN, symptoms, countNthExposition() (+14 more)
...
Cohesion: 0.1
Nodes (20): actions, load(), LOGIN_LIMIT, schema, actions, load(), profileSchema, seed() (+12 more)
...
Cohesion: 0.12
Nodes (21): FORBIDDEN_FOODS, categoryLabel(), computeReminders(), push(), Reminder, ReminderInput, Severity, SEVERITY_RANK (+13 more)
...
Cohesion: 0.16
Nodes (15): actions, ActiveInvite, checkJoinInviteLookupLimit(), findActiveInvitation(), load(), userHasMembership(), hasUniqueShape(), isUniqueViolation() (+7 more)
...
Cohesion: 0.19
Nodes (15): getAllStagesForBento(), getStageForAgeMonths(), Stage, loadAllergenStatus(), load(), AllergenReportRow, load(), ReportEntry (+7 more)
...
Cohesion: 0.29
Nodes (5): resolveMessageKey(), trackSubmission(), $lib/paraglide/messages.js, getTextureLabel(), LABEL_FNS
...
Cohesion: 0.47
Nodes (4): InsertSymptomInput, InsertSymptomResult, getReactionLabel(), ReactionId
...
- **Why does `languageTag()` connect `i18n Messages (auth.*)` to `Community 65`, `Community 92`, `Community 37`?**
  _High betweenness centrality (0.083) - this node is a cross-community bridge._
- **Why does `localizedHref()` connect `Community 37` to `i18n Messages (auth.*)`, `Sentry Observability`?**
  _High betweenness centrality (0.016) - this node is a cross-community bridge._
- **Why does `handleOnline()` connect `Auth Guards & Sessions` to `Community 78`?**
