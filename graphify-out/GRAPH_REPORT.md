# Graph Report - diversif  (2026-07-04)

## Corpus Check
- 585 files · ~395,477 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4570 nodes · 9051 edges · 210 communities (195 shown, 15 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 204 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `4d828fd6`
...
1. `testDb` - 96 edges
2. `makeRouteEvent()` - 88 edges
3. `resetTestDb()` - 81 edges
4. `users` - 74 edges
5. `safeUser()` - 71 edges
6. `db` - 65 edges
7. `requireUser()` - 58 edges
8. `captureFlow()` - 54 edges
9. `seedUser()` - 54 edges
10. `seedChild()` - 53 edges

## Surprising Connections (you probably didn't know these)
- `requireFreshAuth()` --calls--> `fail()`  [INFERRED]
  src/lib/server/fresh-auth.ts → scripts/verify-backup-restore.ts
- `requireFreshAuthWithKey()` --calls--> `fail()`  [INFERRED]
  src/lib/server/fresh-auth.ts → scripts/verify-backup-restore.ts
- `parseBundle()` --calls--> `unique()`  [INFERRED]
  project.inlang/modules/plugin-message-format.js → e2e/_helpers.ts
- `parseVariants()` --calls--> `unique()`  [INFERRED]
  project.inlang/modules/plugin-message-format.js → e2e/_helpers.ts
- `parseForm()` --calls--> `fail()`  [INFERRED]
  src/lib/server/forms.ts → scripts/verify-backup-restore.ts
...
Cohesion: 0.12
Nodes (14): loadFor(), actions, eventWithDiet(), generateInviteCodeRawSpy, _invitesRef, realAuth, setup(), CookieRecord (+6 more)

### Community 1 - "i18n Messages (chrome.*)"
Cohesion: 0.13
Nodes (34): foodEntries, foods, symptoms, seedFood(), seedFoodEntry(), makeDeleteEvent(), makeFormEvent(), seedSymptom() (+26 more)

### Community 2 - "i18n Messages (errors+log+landing)"
Cohesion: 0.11
Nodes (42): PASSKEY_AUTOFILL_OPTIONS_LIMIT, PASSKEY_OPTIONS_LIMIT, POST(), createSession(), requireFreshAuth(), assertRpidOrigin(), AuthenticationResult, base64UrlToBuffer() (+34 more)

### Community 3 - "Page Loaders & Form Actions"
Cohesion: 0.08
Nodes (35): hasUniqueShape(), isUniqueViolation(), Session, ./$types, ./$types, actions, load(), LOGIN_EMAIL_LIMIT (+27 more)

### Community 4 - "Test Fixtures & Setup Helpers"
Cohesion: 0.06
Nodes (39): axeSweep(), AxeViolation, formatViolations(), PUBLIC_ROUTES, TAGS, signUp(), awaitHydration(), dismissWelcomeIfPresent() (+31 more)

### Community 5 - "Branding, App Shell & PWA Manifest"
Cohesion: 0.10
Nodes (28): seedInvite(), IdempotencyKey, idempotencyKeys, Invitation, invitations, NewChild, NewFood, NewFoodEntry (+20 more)

### Community 6 - "Architecture Patterns & Conventions"
Cohesion: 0.07
Nodes (9): $lib/components/bento/BentoMark.svelte, baseProps, foods, user, error, success, page, setPagePathname() (+1 more)

### Community 7 - "Auth Routes & i18n Routing"
Cohesion: 0.12
Nodes (30): seed(), passkeys, users, seed(), seed(), seedTestUser(), auditSpy, seed() (+22 more)

### Community 8 - "UI Components & Tests"
Cohesion: 0.00
Nodes (546): addSymptomLabel, addSymptomNote, addSymptomNotePlaceholder, addSymptomObservedAt, addSymptomSeveritySevereSrPrefix, addSymptomSubmit, addSymptomTitle, allergenArachide (+538 more)
...
Cohesion: 0.06
Nodes (37): categoryLabel(), computeReminders(), MaintainCandidate, push(), Reminder, ReminderInput, RuleContext, ruleForbiddenFoods() (+29 more)

### Community 11 - "User Memory & Medical Audit"
Cohesion: 0.07
Nodes (25): ./ChildCardRow.svelte, ./CompteSection.svelte, ./CoparentsSection.svelte, $lib/components/bento/DiscoverBento.svelte, $lib/components/bento/ProfilBento.svelte, $lib/components/JsonLd.svelte, $lib/components/LocaleSwitcher.svelte, $lib/components/PublicFooter.svelte (+17 more)
...
Cohesion: 0.04
Nodes (47): autoprefixer, bun-plugin-svelte, @inlang/paraglide-sveltekit, lint-staged, postcss, tailwindcss-animate, @testing-library/user-event, tslib (+39 more)

### Community 14 - "Account Export / Delete"
Cohesion: 0.10
Nodes (29): actions, ActiveInvite, checkJoinInviteLookupLimit(), findActiveInvitation(), JOIN_INVITE_LOOKUP_LIMIT, load(), userHasMembership(), actions (+21 more)

### Community 15 - "DB Init, Backup & Seed"
Cohesion: 0.08
Nodes (27): $lib/components/bento/AddSymptomSheet.svelte, $lib/components/bento/BentoAuthLayout.svelte, $lib/components/bento/OnboardingForm.svelte, @simplewebauthn/browser, $lib/components/ReactionPicker.svelte, $lib/components/WelcomeDialog.svelte, svelte/elements, $app/environment (+19 more)

### Community 16 - "Allergens & Milestones"
Cohesion: 0.08
Nodes (22): drainPool(), EndablePool, Logger, registerShutdownHandlers(), _resetShutdownState(), ShutdownOptions, makeHarness(), makeProc() (+14 more)

### Community 17 - "Sentry Observability"
Cohesion: 0.12
Nodes (21): #each(), $lib/components/AllergenInfoDialog.svelte, $lib/components/GuideStaticSections.svelte, $lib/components/SourceCitation.svelte, sources, $lib/components/StageBadge.svelte, $lib/components/TipCard.svelte, $lib/content/guidance (+13 more)

### Community 18 - "Legal Pages"
Cohesion: 0.09
Nodes (36): Membership, destinationFor(), loadEntry(), schema, ./$types, ./$types, load(), SafeUser (+28 more)
...
Cohesion: 0.15
Nodes (21): execRows(), Executor, ./$types, actions, AllergenSummary, buildObservationReminder(), load(), summarizeAllergens() (+13 more)
...
Cohesion: 0.17
Nodes (24): SEVERE, Severity, severityOf(), SYMPTOM_LABELS, SymptomLabel, symptomLabelText(), WARN, countNthExposition() (+16 more)

### Community 23 - "Migration Tests"
Cohesion: 0.09
Nodes (18): purgeBeforeSubmit(), purgeClientState(), CachesLike, globalWithCaches, ActionError, ActionFailure, ActionRedirect, ActionResult (+10 more)

### Community 24 - "Food Categories"
Cohesion: 0.21
Nodes (13): CHARCUTERIE_MATCHERS, CHOKING_BY_FOOD, FAT_EXCLUDE, FULL_DAY, MEAL_TEMPLATES, MealId, NOVELTY_CATEGORIES, OILY_FISH (+5 more)
...
Cohesion: 0.15
Nodes (12): $lib/components/CategoryTag.svelte, $lib/components/FoodCombobox.svelte, $lib/components/PrintShell.svelte, dayjs/locale/fr, $lib/paraglide/runtime, $lib/utils/age, $lib/utils/categories, $lib/utils/reactions (+4 more)

### Community 28 - "Reactions Vocabulary"
Cohesion: 0.11
Nodes (27): Stage, User, InsertSymptomResult, ./$types, RecentEntry, SymptomEntry, aggregateFoods(), AllergenReportRow (+19 more)

### Community 29 - "Diversity Metrics"
Cohesion: 0.18
Nodes (14): loadFor(), loadFor(), makeAutofillEvent(), makeModalEvent(), mocks, makeReq(), mocks, makeReq() (+6 more)

### Community 30 - "Reminders Engine"
Cohesion: 0.05
Nodes (44): source, enabledPlugins, chrome-devtools-mcp@claude-plugins-official, claude-md-management@claude-plugins-official, cloudflare@claude-plugins-official, code-review@claude-plugins-official, code-simplifier@claude-plugins-official, coderabbit@claude-plugins-official (+36 more)

### Community 31 - "Community 31"
Cohesion: 0.13
Nodes (19): aggregateBentoFoods(), BentoFood, BentoSourceRow, buildFoodFilters(), load(), loadBentoAllergens(), loadWeeklyEntries(), AllergenItem (+11 more)
...
Cohesion: 0.08
Nodes (14): authenticateWithPasskey(), PasskeyAuthResult, PasskeyErrorKey, signInWithPasskey(), FakeResponse, toastErrorCalls, ./CarnetAllergens.svelte, $lib/components/bento/CarnetBento.svelte (+6 more)

### Community 35 - "Community 35"
Cohesion: 0.09
Nodes (23): key, last_used_at, redirect, scope, autoincrement, name, notNull, autoincrement (+15 more)

### Community 36 - "Community 36"
Cohesion: 0.13
Nodes (15): columnsFrom, name, onDelete, onUpdate, tableFrom, tableTo, food_entries_child_id_children_id_fk, memberships_child_id_children_id_fk (+7 more)
...
Cohesion: 0.08
Nodes (25): autoincrement, name, notNull, primaryKey, type, autoincrement, name, notNull (+17 more)
...
Cohesion: 0.09
Nodes (11): filtered, ./FoodCard.svelte, baseClass, ./MonitorTimer.svelte, $lib/components/bento/RasCard.svelte, $lib/components/bento/ReactionDetailBento.svelte, $lib/components/TexturePicker.svelte, #each() (+3 more)

### Community 41 - "Community 41"
Cohesion: 0.10
Nodes (30): ALLERGEN_GUIDANCE, AllergenGuidance, APPROACHES, BentoStage, CATEGORY_GUIDANCE, CategoryGuidance, CHOKING_HAZARDS, ChokingHazard (+22 more)

### Community 42 - "Community 42"
Cohesion: 0.15
Nodes (20): absoluteUrl(), articleJsonLd(), BreadcrumbItem, breadcrumbJsonLd(), faqPageJsonLd(), organizationJsonLd(), resolveOrigin(), SeoInput (+12 more)

### Community 43 - "Community 43"
Cohesion: 0.05
Nodes (38): Conventions, Created (new files), End of plan, File Structure, Foundation: Bento Tokens + shadcn-svelte Primitives — Implementation Plan, Modified, Task 10: Restyle `Button.svelte`, Task 11: Restyle `Card.svelte` (+30 more)

### Community 44 - "Community 44"
Cohesion: 0.12
Nodes (15): id, user_id, dialect, name, notNull, primaryKey, type, prevId (+7 more)
...
Cohesion: 0.11
Nodes (17): tailwind-variants, dependencies, bits-ui, clsx, dayjs, drizzle-orm, @fontsource-variable/fraunces, @fontsource-variable/inter (+9 more)

### Community 50 - "Community 50"
Cohesion: 0.06
Nodes (40): name, onDelete, onUpdate, tableFrom, columnsFrom, columnsTo, name, onDelete (+32 more)

### Community 51 - "Community 51"
Cohesion: 0.08
Nodes (33): food_entries_texture_check, checkConstraints, compositePrimaryKeys, indexes, name, memberships_user_id_child_id_pk, foreignKeys, name (+25 more)

### Community 52 - "Community 52"
Cohesion: 0.15
Nodes (26): amountFor(), applyAllergenFocusAndNovelty(), applyDayNovelty(), assembleFullDayMeals(), buildStarterMeal(), catalogSafe(), cautionFor(), CHARCUTERIE() (+18 more)

### Community 53 - "Community 53"
Cohesion: 0.10
Nodes (21): columnsFrom, columnsTo, name, onDelete, onUpdate, tableFrom, tableTo, children_created_by_users_id_fk (+13 more)

### Community 54 - "Community 54"
Cohesion: 0.11
Nodes (18): autoincrement, name, notNull, primaryKey, type, columns, birth_date, created_at (+10 more)
...
Cohesion: 0.10
Nodes (13): load(), exportSpy, seedUser(), seed(), withJsonBody(), fakeUser, mocks, load() (+5 more)
...
Cohesion: 0.15
Nodes (15): ./$types, ./$types, actions, deleteSchema, load(), renameSchema, actions, load() (+7 more)
...
Cohesion: 0.12
Nodes (11): $lib/components/ReloadPrompt.svelte, $components/ThemeToggle.svelte, ../app.css, $lib/offline/purge, $lib/offline/queue, $lib/utils/theme, ./$types, bentoKids (+3 more)

### Community 69 - "Community 69"
Cohesion: 0.17
Nodes (10): ./$types, ./$types, load(), load(), getLegalIdentity(), isPlaceholder(), LegalIdentity, read() (+2 more)

### Community 70 - "Community 70"
Cohesion: 0.23
Nodes (10): Child, FoodEntry, Passkey, GET(), DeletionSummary, ExportedUser, ExportTooLargeError, exportUserData() (+2 more)

### Community 71 - "Community 71"
Cohesion: 0.15
Nodes (16): variables, variables, deploy, startCommand, variables, variables, packages, bun (+8 more)

### Community 72 - "Community 72"
Cohesion: 0.12
Nodes (16): autoincrement, name, notNull, primaryKey, type, category, is_major_allergen, texture (+8 more)

### Community 73 - "Community 73"
Cohesion: 0.07
Nodes (27): Components, Council review — rounds 1–3 addressed, Data flow, Data model, Delivery phases, Error handling / edge cases, Filtering & rotation — over the compacted **introduced-safe** list (fixes F1/F2/NEW-1/F8), Goals (+19 more)
...
Cohesion: 0.12
Nodes (14): applyNextMarker(), args, covRoot, elapsedSec, failedFiles, files, isNonExecutable(), parseIgnoredLines() (+6 more)

### Community 78 - "Community 78"
Cohesion: 0.15
Nodes (13): public_key, columnsFrom, columnsTo, name, onDelete, onUpdate, tableFrom, tableTo (+5 more)
...
Cohesion: 0.19
Nodes (9): AnyDb, applySeedCorrections(), FOODS_SEED, SeedFood, seedFoods(), Tx, MenuInput, CATALOG (+1 more)

### Community 82 - "Community 82"
Cohesion: 0.08
Nodes (27): autoincrement, name, primaryKey, type, allergen_type, custom_for_child_id, name, suggested_age_months (+19 more)

### Community 83 - "Community 83"
Cohesion: 0.09
Nodes (23): given_at, logged_by, notes, reaction, columns, autoincrement, name, notNull (+15 more)
...
Cohesion: 0.18
Nodes (12): lint-staged, patchedDependencies, @inlang/sdk@0.37.0, license, lint-staged, *.{json,md,css,html}, *.{ts,js,svelte}, name (+4 more)
...
Cohesion: 0.16
Nodes (7): ./AllergensSnapshot.svelte, $lib/components/bento/AujourdhuiBento.svelte, streakLabel, $lib/server/guidance/reminders, $lib/types, $components/ui/CalloutCard.svelte, cn()

### Community 98 - "Community 98"
Cohesion: 0.15
Nodes (13): columns, name, columns, isUnique, name, indexes, foods_custom_for_child_idx, idempotency_keys_created_at_idx (+5 more)
...
Cohesion: 0.12
Nodes (16): Combined Dead Code + Duplication, Cross-directory only, Duplication Threshold CI Gate, Fallow: Common Workflow Patterns & Recipes, Full audit (default), PR Dead Code Check, Production audit, Production vs Full Audit (+8 more)

### Community 103 - "Community 103"
Cohesion: 0.23
Nodes (9): ./$types, PARIS, parisDay(), beforeLocalMidnight, localMidnightPlus30, buildMenu(), load(), DIET_EXCLUSIONS (+1 more)
...
Cohesion: 0.25
Nodes (7): 1. Create the Sentry project, 2. Create an internal integration auth token, 3. Wire env vars in Coolify, 4. Configure an alert rule, 5. Smoke test, 6. Privacy policy ack, Sentry setup — operator runbook
...
Cohesion: 0.24
Nodes (8): baseLocale, languageTags, locales, modules, plugin.inlang.messageFormat, pathPattern, $schema, sourceLanguageTag

### Community 110 - "Community 110"
Cohesion: 0.38
Nodes (8): tipDismissals, auditSpy, auditSpy, insertChild(), insertEntry(), insertFood(), insertMembership(), insertUser()
...
Cohesion: 0.11
Nodes (18): counter, is_custom, transports, autoincrement, name, notNull, primaryKey, type (+10 more)

### Community 113 - "Community 113"
Cohesion: 0.12
Nodes (14): args, childIds, ChildRow, client, db, EntryRow, inList, MembershipRow (+6 more)
...
Cohesion: 0.29
Nodes (5): createFormToasts(), KeysOf, resolveMessageKey(), noCancel, trackSubmission()

### Community 116 - "Community 116"
Cohesion: 0.29
Nodes (8): columns, name, food_entries_child_idx, invitations_expires_at_idx, columns, isUnique, name, indexes
...
Cohesion: 0.10
Nodes (27): load(), VALID_THEMES, db, drizzleDb, pool, resolveDatabasePath(), sqlite, children (+19 more)

### Community 119 - "Community 119"
Cohesion: 0.13
Nodes (14): audit, gate, duplicates, minOccurrences, entry, health, maxCognitive, maxCrap (+6 more)
...
Cohesion: 0.10
Nodes (17): eventRoute(), filterIncomingBreadcrumb(), ScrubbableEvent, scrubBreadcrumbData(), scrubBreadcrumbs(), scrubEvent(), scrubException(), scrubPathname() (+9 more)
...
Cohesion: 0.25
Nodes (7): Decisions (confirmed with owner), Deliverables, Inventory (as discovered), Local (uncommitted) cleanup, Reproducible Claude Code setup — design, Security, Verification
...
Cohesion: 0.25
Nodes (6): client, db, rows, stale, StaleRow, threshold
...
Cohesion: 0.29
Nodes (6): entry, ignoreBinaries, ignoreDependencies, project, $schema, knip
...
Cohesion: 0.24
Nodes (8): StageId, getQuantitiesForStage(), QUANTITIES, StageQuantities, Food, Menu, makeFood(), makeMenu()

### Community 151 - "Community 151"
Cohesion: 0.12
Nodes (16): food_id, role, used_by, autoincrement, name, primaryKey, type, autoincrement (+8 more)
...
Cohesion: 0.18
Nodes (11): autoincrement, name, notNull, primaryKey, type, backed_up, created_by, autoincrement (+3 more)

### Community 158 - "Community 158"
Cohesion: 0.23
Nodes (11): ruleCategoryImbalance(), CATEGORY_IDS, CATEGORY_LABEL_RESOLVERS, CategoryClasses, CategoryColor, CLASS_MAP, getCategoryClasses(), getCategoryColor() (+3 more)

### Community 159 - "Community 159"
Cohesion: 0.40
Nodes (4): Cross-cutting, Output, Session & hashing, What to check (WebAuthn ceremony — the high-value bugs)
...
Cohesion: 0.40
Nodes (4): Email verification / transactional mail sender, Explicitly out of scope for the hardening pass, Off-box backup scheduling (Litestream → R2), Parking lot
...
Cohesion: 0.50
Nodes (3): How to audit, Output, What "correct" looks like in this codebase

### Community 168 - "Community 168"
Cohesion: 0.50
Nodes (3): create-migration, If a just-generated migration is wrong, Steps

### Community 169 - "Community 169"
Cohesion: 0.50
Nodes (3): i18n-add-key, Pitfalls, Steps
...
Cohesion: 0.25
Nodes (6): challenges, client, db, invitations, now, sessions

### Community 734 - "Community 734"
Cohesion: 0.33
Nodes (4): EXCLUDED_DIRS, offenders, ROOT, SRC

## Knowledge Gaps
- **2698 isolated node(s):** `$schema`, `superpowers@claude-plugins-official`, `frontend-design@claude-plugins-official`, `code-review@claude-plugins-official`, `code-simplifier@claude-plugins-official` (+2693 more)
...
- **Why does `devDependencies` connect `UI Component Library` to `Community 136`, `Community 49`, `Community 178`, `Community 93`?**
  _High betweenness centrality (0.016) - this node is a cross-community bridge._
- **Why does `svelte` connect `UI Component Library` to `Architecture Patterns & Conventions`?**
  _High betweenness centrality (0.015) - this node is a cross-community bridge._
- **Why does `dependencies` connect `Community 49` to `Community 93`?**
  _High betweenness centrality (0.009) - this node is a cross-community bridge._
- **Are the 8 inferred relationships involving `makeRouteEvent()` (e.g. with `makeDeleteEvent()` and `makeFormEvent()`) actually correct?**
  _`makeRouteEvent()` has 8 INFERRED edges - model-reasoned connections that need verification._
- **What connects `$schema`, `superpowers@claude-plugins-official`, `frontend-design@claude-plugins-official` to the rest of the system?**
...
- **Should `i18n Messages (chrome.*)` be split into smaller, more focused modules?**
  _Cohesion score 0.12585933368588048 - nodes in this community are weakly interconnected._