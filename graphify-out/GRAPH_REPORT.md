...
## Summary
- 4443 nodes · 9020 edges · 166 communities (152 shown, 14 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 193 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `a4aef603`
...
Cohesion: 0.01
Nodes (241): addSymptomNote(), addSymptomNotePlaceholder(), addSymptomTitle(), allergenDialogBadgeFromMonths(), allergenDialogClose(), allergenDialogFirstSignsTitle(), allergenDialogHowToOfferTitle(), allergenDialogSeverityMajor() (+233 more)

### Community 1 - "i18n Messages (chrome.*)"
Cohesion: 0.01
Nodes (117): addSymptomLabel(), addSymptomObservedAt(), addSymptomSubmit(), allergenDialogSevereSignsTitle(), aujourdhuiBilanAliments(), aujourdhuiBilanStreakRecord(), aujourdhuiRecentEmpty(), authAccountDeleteSubmit() (+109 more)

### Community 2 - "i18n Messages (errors+log+landing)"
Cohesion: 0.01
Nodes (175): addSymptomLabel(), addSymptomNote(), addSymptomNotePlaceholder(), addSymptomTitle(), allergenDialogFirstSignsTitle(), allergenDialogHowToOfferTitle(), allergenDialogSeverityMajor(), aujourdhuiAllergensFading() (+167 more)

### Community 3 - "Page Loaders & Form Actions"
Cohesion: 0.01
Nodes (174): addSymptomLabel(), addSymptomNote(), addSymptomNotePlaceholder(), addSymptomObservedAt(), addSymptomSubmit(), addSymptomTitle(), allergenDialogBadgeFromMonths(), allergenDialogClose() (+166 more)

### Community 4 - "Test Fixtures & Setup Helpers"
Cohesion: 0.01
Nodes (134): addSymptomSeveritySevereSrPrefix(), aujourdhuiAllergensTodo(), aujourdhuiBilanStreakDaysOne(), aujourdhuiBilanStreakRecord(), aujourdhuiRecentEmptyCta(), authAccountAppearanceSection(), authAccountDeleteConfirmLabel(), authAccountDeleteDescription() (+126 more)

### Community 5 - "Branding, App Shell & PWA Manifest"
Cohesion: 0.01
Nodes (131): addSymptomObservedAt(), allergenDialogSevereSignsTitle(), allergenDialogSourcesTitle(), aujourdhuiAllergensOk(), aujourdhuiBilanAliments(), authAccountCurrentPasswordLabel(), authAccountDeleteDescription(), authAccountDeletePasswordLabel() (+123 more)

### Community 6 - "Architecture Patterns & Conventions"
Cohesion: 0.01
Nodes (194): addSymptomSeveritySevereSrPrefix(), addSymptomSubmit(), allergenDialogBadgeFromMonths(), allergenDialogClose(), allergenDialogTitle(), allergenDialogWhyEarlyTitle(), allergenPassportFadingHint, allergenPassportSectionOther (+186 more)

### Community 7 - "Auth Routes & i18n Routing"
Cohesion: 0.01
Nodes (192): allergenDialogFirstSignsTitle(), allergenDialogSourcesTitle(), allergenDialogWhyEarlyTitle(), allergenPassportFadingHint, allergenPassportSectionOther, allergenPassportSectionPriority, allergenPassportStateCleared, allergenPassportStateFading (+184 more)
...
Cohesion: 0.06
Nodes (65): seed(), VALID_THEMES, db, memberships, users, actions, load(), seed() (+57 more)

### Community 10 - "Offline Log Queue (IndexedDB)"
Cohesion: 0.06
Nodes (61): load(), PASSKEY_AUTOFILL_OPTIONS_LIMIT, PASSKEY_OPTIONS_LIMIT, POST(), actions, deleteSchema, load(), renameSchema (+53 more)

### Community 11 - "User Memory & Medical Audit"
Cohesion: 0.05
Nodes (52): Child, children, Food, FoodEntry, IdempotencyKey, Invitation, invitations, NewChild (+44 more)

### Community 12 - "SEO / JSON-LD Library"
Cohesion: 0.07
Nodes (51): SEVERE, Severity, severityOf(), SYMPTOM_LABELS, SymptomLabel, WARN, Membership, symptoms (+43 more)

### Community 13 - "UI Component Library"
Cohesion: 0.05
Nodes (6): baseProps, foods, user, page, setPagePathname(), textSnippet()

### Community 14 - "Account Export / Delete"
Cohesion: 0.09
Nodes (23): @simplewebauthn/browser, svelte/elements, $app/environment, $app/forms, $app/navigation, $lib/content/symptoms, $lib/forms/tracked-enhance, $lib/i18n (+15 more)

### Community 15 - "DB Init, Backup & Seed"
Cohesion: 0.08
Nodes (13): ../app.css, $lib/offline/queue, $lib/seo, $lib/utils/localized-href, $lib/utils/milestones, $lib/utils/theme, bentoKids, firstChildId (+5 more)
...
Cohesion: 0.08
Nodes (15): #each(), introducedCount, other, stateIcon(), $lib/content/did-you-know, $lib/content/recipes, $lib/server/guidance/allergen-status, $lib/utils/suggest (+7 more)
...
Cohesion: 0.07
Nodes (10): filtered, baseClass, $lib/paraglide/runtime, $lib/utils/age, $lib/utils/categories, $lib/utils/reactions, $lib/utils/search, $lib/utils/texture-labels (+2 more)

### Community 23 - "Migration Tests"
Cohesion: 0.14
Nodes (7): FRUITS, sources, $lib/content/guidance, $lib/content/sources, $lib/utils/allergens, ./$types, ./SeasonalFoods.svelte
...
Cohesion: 0.08
Nodes (7): streakLabel, $lib/paraglide/messages.js, $lib/server/guidance/reminders, $lib/types, $lib/utils/monitor-timer, getTextureLabel(), LABEL_FNS
...
Cohesion: 0.17
Nodes (16): SAMPLE, getAllStagesForBento(), getStageForAgeMonths(), StageId, getRecipesForStage(), Recipe, RECIPES, loadAllergenStatus() (+8 more)
...
Cohesion: 0.16
Nodes (12): Stage, InsertSymptomResult, AllergenReportRow, load(), ReportEntry, ReportFood, ./$types, getReactionLabel() (+4 more)
...
- **Why does `languageTag()` connect `Community 38` to `i18n Messages (auth.*)`, `i18n Messages (chrome.*)`, `Community 93`, `Community 46`?**
  _High betweenness centrality (0.084) - this node is a cross-community bridge._
- **Why does `devDependencies` connect `Legal Pages` to `Community 94`?**
