...
## Corpus Check
- 370 files · ~491,177 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2514 nodes · 3423 edges · 258 communities (201 shown, 57 thin omitted)
- Extraction: 81% EXTRACTED · 19% INFERRED · 0% AMBIGUOUS · INFERRED: 639 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `23164487`
...
- **Why does `languageTag()` connect `i18n Messages (auth.*)` to `UI Components & Tests`, `Community 72`, `SEO / JSON-LD Library`?**
