...
## Summary
- 4443 nodes · 9020 edges · 169 communities (153 shown, 16 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 193 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `ac8b050d`
...
Cohesion: 0.01
Nodes (117): addSymptomNote(), addSymptomNotePlaceholder(), allergenDialogSourcesTitle(), allergenDialogTitle(), aujourdhuiAllergensFading(), aujourdhuiBilanStreak(), aujourdhuiBilanStreakDaysOther(), aujourdhuiRecentTitle() (+109 more)

### Community 1 - "i18n Messages (chrome.*)"
Cohesion: 0.01
Nodes (241): addSymptomLabel(), addSymptomObservedAt(), addSymptomSubmit(), addSymptomTitle(), allergenDialogBadgeFromMonths(), allergenDialogClose(), allergenDialogFirstSignsTitle(), allergenDialogHowToOfferTitle() (+233 more)

### Community 2 - "i18n Messages (errors+log+landing)"
Cohesion: 0.01
Nodes (175): addSymptomNote(), addSymptomObservedAt(), addSymptomSubmit(), allergenDialogBadgeFromMonths(), allergenDialogClose(), allergenDialogFirstSignsTitle(), allergenDialogSevereSignsTitle(), allergenDialogSourcesTitle() (+167 more)

### Community 3 - "Page Loaders & Form Actions"
Cohesion: 0.01
Nodes (174): addSymptomLabel(), addSymptomNote(), addSymptomObservedAt(), addSymptomSubmit(), allergenDialogClose(), allergenDialogFirstSignsTitle(), allergenDialogHowToOfferTitle(), allergenDialogSeverityMajor() (+166 more)

### Community 4 - "Test Fixtures & Setup Helpers"
Cohesion: 0.01
Nodes (132): addSymptomNotePlaceholder(), addSymptomTitle(), allergenDialogSourcesTitle(), aujourdhuiAllergensTodo(), aujourdhuiBilanStreakDaysOther(), aujourdhuiBilanStreakRecord(), aujourdhuiRecentEmpty(), aujourdhuiRecentEmptyCta() (+124 more)

### Community 5 - "Branding, App Shell & PWA Manifest"
Cohesion: 0.01
Nodes (132): addSymptomNotePlaceholder(), addSymptomTitle(), allergenDialogSeverityMajor(), aujourdhuiAllergensOk(), aujourdhuiAllergensTodo(), aujourdhuiBilanStreakRecord(), aujourdhuiRecentEmptyCta(), aujourdhuiRecentTitle() (+124 more)

### Community 6 - "Architecture Patterns & Conventions"
Cohesion: 0.01
Nodes (194): addSymptomSeveritySevereSrPrefix(), allergenDialogBadgeFromMonths(), allergenDialogSevereSignsTitle(), allergenDialogTitle(), allergenPassportFadingHint, allergenPassportSectionOther, allergenPassportSectionPriority, allergenPassportStateCleared (+186 more)

### Community 7 - "Auth Routes & i18n Routing"
Cohesion: 0.01
Nodes (193): addSymptomLabel(), addSymptomSeveritySevereSrPrefix(), allergenDialogHowToOfferTitle(), allergenDialogTitle(), allergenDialogWhyEarlyTitle(), allergenPassportFadingHint, allergenPassportSectionOther, allergenPassportSectionPriority (+185 more)
...
Cohesion: 0.06
Nodes (58): SEVERE, Severity, severityOf(), SYMPTOM_LABELS, SymptomLabel, WARN, db, drizzleDb (+50 more)
...
Cohesion: 0.06
Nodes (55): seed(), actions, load(), seed(), actions, load(), LOGIN_LIMIT, schema (+47 more)

### Community 12 - "SEO / JSON-LD Library"
Cohesion: 0.05
Nodes (55): Child, children, Food, FoodEntry, IdempotencyKey, Invitation, invitations, Membership (+47 more)

### Community 13 - "UI Component Library"
Cohesion: 0.06
Nodes (6): foods, user, $lib/utils/theme, page, setPagePathname(), textSnippet()

### Community 14 - "Account Export / Delete"
Cohesion: 0.07
Nodes (15): ../app.css, $lib/offline/queue, $lib/paraglide/messages, $lib/seo, $lib/utils/localized-href, $lib/utils/milestones, ./$types, ./$types (+7 more)
...
Cohesion: 0.1
Nodes (26): InsertSymptomResult, categoryLabel(), computeReminders(), push(), Reminder, ReminderInput, Severity, SEVERITY_RANK (+18 more)

### Community 21 - "Diversification Guidance & Stages"
Cohesion: 0.13
Nodes (22): execRows(), Executor, actions, AllergenSummary, load(), dismissReminder(), loadDismissals(), ttlForReminderKey() (+14 more)
...
Cohesion: 0.07
Nodes (8): baseProps, $lib/content/symptoms, $lib/types, $lib/utils/age, $lib/utils/monitor-timer, $lib/utils/reactions, $lib/utils/texture-labels, ./$types
...
Cohesion: 0.06
Nodes (31): given_at, logged_by, notes, reaction, texture, columns, autoincrement, name (+23 more)
...
Cohesion: 0.14
Nodes (18): SAMPLE, getAllStagesForBento(), getStageForAgeMonths(), StageId, getRecipesForStage(), Recipe, RECIPES, getSeasonalNames() (+10 more)
...
Cohesion: 0.08
Nodes (25): autoincrement, name, notNull, primaryKey, type, backed_up, device_type, last_used_at (+17 more)
...
Cohesion: 0.13
Nodes (7): i18n, $lib/paraglide/messages.js, reroute, cn(), localizedHref(), getTextureLabel(), LABEL_FNS
...
Cohesion: 0.19
Nodes (11): Stage, AllergenReportRow, load(), ReportEntry, ReportFood, ./$types, ageInMonths(), formatAge() (+3 more)
...
- **Why does `languageTag()` connect `Community 36` to `i18n Messages (auth.*)`, `i18n Messages (chrome.*)`, `Community 94`, `Community 47`?**
  _High betweenness centrality (0.084) - this node is a cross-community bridge._
- **Why does `devDependencies` connect `Sentry Observability` to `Community 95`?**
