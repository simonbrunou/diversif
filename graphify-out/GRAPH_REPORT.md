...
## Corpus Check
- 459 files · ~384,316 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4546 nodes · 8554 edges · 174 communities (159 shown, 15 thin omitted)
- Extraction: 91% EXTRACTED · 9% INFERRED · 0% AMBIGUOUS · INFERRED: 796 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `602a2a30`
...
Cohesion: 0.01
Nodes (597): addSymptomLabel(), addSymptomNote(), addSymptomNotePlaceholder(), addSymptomObservedAt(), addSymptomSeveritySevereSrPrefix(), addSymptomSubmit(), addSymptomTitle(), aideNavLabel() (+589 more)

### Community 1 - "i18n Messages (chrome.*)"
Cohesion: 0.01
Nodes (174): addSymptomLabel(), addSymptomObservedAt(), addSymptomTitle(), allergenDialogBadgeFromMonths(), allergenDialogFirstSignsTitle(), allergenDialogSeverityMajor(), aujourdhuiAllergensFading(), aujourdhuiBilanAlimentsDelta() (+166 more)

### Community 2 - "i18n Messages (errors+log+landing)"
Cohesion: 0.01
Nodes (174): addSymptomLabel(), addSymptomNote(), addSymptomNotePlaceholder(), addSymptomObservedAt(), addSymptomTitle(), allergenDialogBadgeFromMonths(), allergenDialogFirstSignsTitle(), allergenDialogHowToOfferTitle() (+166 more)

### Community 3 - "Page Loaders & Form Actions"
Cohesion: 0.01
Nodes (321): addSymptomNote(), addSymptomNotePlaceholder(), addSymptomSeveritySevereSrPrefix(), addSymptomSubmit(), allergenDialogClose(), allergenDialogHowToOfferTitle(), allergenDialogSevereSignsTitle(), allergenDialogSourcesTitle() (+313 more)

### Community 4 - "Test Fixtures & Setup Helpers"
Cohesion: 0.01
Nodes (321): addSymptomSeveritySevereSrPrefix(), addSymptomSubmit(), allergenDialogClose(), allergenDialogSevereSignsTitle(), allergenDialogSeverityMajor(), allergenDialogSourcesTitle(), allergenDialogTitle(), allergenPassportFadingHint (+313 more)

### Community 5 - "Branding, App Shell & PWA Manifest"
Cohesion: 0.07
Nodes (54): load(), foodEntries, foods, makeDeleteEvent(), makeFormEvent(), setup(), exportSpy, loadFor() (+46 more)

### Community 6 - "Architecture Patterns & Conventions"
Cohesion: 0.07
Nodes (50): load(), VALID_THEMES, db, drizzleDb, pool, sqlite, actions, load() (+42 more)

### Community 7 - "Auth Routes & i18n Routing"
Cohesion: 0.05
Nodes (53): seed(), seed(), seed(), seedTestUser(), POST(), seed(), actions, load() (+45 more)

### Community 8 - "UI Components & Tests"
Cohesion: 0.07
Nodes (51): PASSKEY_AUTOFILL_OPTIONS_LIMIT, PASSKEY_OPTIONS_LIMIT, POST(), actions, deleteSchema, load(), renameSchema, audit() (+43 more)

### Community 9 - "WebAuthn / Passkeys"
Cohesion: 0.06
Nodes (37): axeSweep(), AxeViolation, formatViolations(), PUBLIC_ROUTES, TAGS, dismissWelcomeIfPresent(), expectBottomSheet(), expectDialogMatchesViewport() (+29 more)

### Community 10 - "Offline Log Queue (IndexedDB)"
Cohesion: 0.07
Nodes (50): Child, children, Food, FoodEntry, IdempotencyKey, idempotencyKeys, Invitation, invitations (+42 more)
...
Cohesion: 0.07
Nodes (7): $lib/i18n, $lib/paraglide/messages, $lib/types, $lib/utils/localized-href, $lib/utils/milestones, $lib/utils/monitor-timer, $app/state
...
Cohesion: 0.07
Nodes (6): authenticateWithPasskey(), signInWithPasskey(), i18n, reroute, cn(), localizedHref()

### Community 18 - "Legal Pages"
Cohesion: 0.1
Nodes (22): execRows(), Executor, load(), loadBentoAllergens(), loadWeeklyEntries(), AllergenItem, PRIORITY_SET, dismissReminder() (+14 more)

### Community 19 - "Invitations & Memberships"
Cohesion: 0.16
Nodes (7): sources, $lib/content/guidance, $lib/content/sources, $lib/seo, $lib/utils/allergens, Icon, string

### Community 20 - "SEO Source-of-Truth Config"
Cohesion: 0.11
Nodes (26): SEVERE, Severity, severityOf(), SYMPTOM_LABELS, SymptomLabel, WARN, symptoms, countNthExposition() (+18 more)
...
Cohesion: 0.09
Nodes (10): filtered, baseClass, dayjs/locale/fr, $lib/utils/age, $lib/utils/categories, $lib/utils/cn, $lib/utils/reactions, $lib/utils/search (+2 more)
...
Cohesion: 0.11
Nodes (24): categoryLabel(), computeReminders(), push(), Reminder, ReminderInput, Severity, SEVERITY_RANK, ALL_ALLERGENS (+16 more)
...
Cohesion: 0.08
Nodes (26): counter, device_type, last_used_at, public_key, autoincrement, default, name, notNull (+18 more)
...
Cohesion: 0.11
Nodes (19): invitations_created_by_users_id_fk, invitations_expires_at_idx, checkConstraints, compositePrimaryKeys, columnsFrom, columnsTo, name, onDelete (+11 more)
...
Cohesion: 0.18
Nodes (12): Stage, AllergenReportRow, load(), ReportEntry, ReportFood, $lib/paraglide/messages.js, getTextureLabel(), LABEL_FNS (+4 more)
...
Cohesion: 0.22
Nodes (14): actions, load(), LOGIN_LIMIT, schema, Bucket, bucketKey(), checkRateLimit(), evictExpiredRateLimits() (+6 more)
...
Cohesion: 0.18
Nodes (12): Membership, User, ChildSummary, RecentEntry, SafeUser, SymptomEntry, load(), fakeUser (+4 more)
...
Cohesion: 0.38
Nodes (8): formatDateInputValue(), formatDateTime(), formatMonthsSince(), formatRelative(), isValidBirthDate(), localInputToIso(), parseDateTimeLocal(), toEpochMs()
...
Cohesion: 0.22
Nodes (9): food_entries_texture_check, checkConstraints, compositePrimaryKeys, foreignKeys, name, name, value, uniqueConstraints (+1 more)
...
Cohesion: 0.25
Nodes (8): columnsFrom, columnsTo, name, onDelete, onUpdate, tableFrom, tableTo, food_entries_logged_by_users_id_fk
...
Cohesion: 0.25
Nodes (8): invitations_child_id_children_id_fk, columnsFrom, columnsTo, name, onDelete, onUpdate, tableFrom, tableTo

### Community 106 - "Community 106"
Cohesion: 0.25
Nodes (8): invitations_used_by_users_id_fk, columnsFrom, columnsTo, name, onDelete, onUpdate, tableFrom, tableTo
...
Cohesion: 0.57
Nodes (6): getAllStagesForBento(), getStageForAgeMonths(), getTipsFor(), loadAllergenStatus(), load(), load()
...
Cohesion: 0.29
Nodes (7): logged_by, columns, autoincrement, name, notNull, primaryKey, type

### Community 114 - "Community 114"
Cohesion: 0.29
Nodes (7): is_custom, autoincrement, default, name, notNull, primaryKey, type
...
Cohesion: 0.33
Nodes (6): reaction, autoincrement, name, notNull, primaryKey, type

### Community 123 - "Community 123"
Cohesion: 0.33
Nodes (6): given_at, autoincrement, name, notNull, primaryKey, type

### Community 124 - "Community 124"
Cohesion: 0.33
Nodes (6): texture, autoincrement, name, notNull, primaryKey, type
...
Cohesion: 0.33
Nodes (6): checkConstraints, columns, compositePrimaryKeys, name, uniqueConstraints, foods
...
Cohesion: 0.33
Nodes (6): autoincrement, name, notNull, primaryKey, type, category

### Community 129 - "Community 129"
Cohesion: 0.33
Nodes (6): suggested_age_months, autoincrement, name, notNull, primaryKey, type
...
Cohesion: 0.33
Nodes (6): autoincrement, name, notNull, primaryKey, type, backed_up
...
Cohesion: 0.4
Nodes (5): columns, isUnique, name, indexes, food_entries_child_idx
...
- **Why does `languageTag()` connect `i18n Messages (auth.*)` to `Sentry Observability`, `Community 91`, `Community 53`?**
  _High betweenness centrality (0.081) - this node is a cross-community bridge._
- **Why does `localizedHref()` connect `Sentry Observability` to `i18n Messages (auth.*)`, `Community 53`, `DB Init, Backup & Seed`?**
  _High betweenness centrality (0.018) - this node is a cross-community bridge._
- **Why does `devDependencies` connect `Account Export / Delete` to `Community 90`?**
  _High betweenness centrality (0.008) - this node is a cross-community bridge._
- **Are the 599 inferred relationships involving `languageTag()` (e.g. with `formatRelative()` and `formatMonthsSince()`) actually correct?**
  _`languageTag()` has 599 INFERRED edges - model-reasoned connections that need verification._
