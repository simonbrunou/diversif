...
## Summary
- 4259 nodes · 8147 edges · 152 communities (138 shown, 14 thin omitted)
- Extraction: 91% EXTRACTED · 9% INFERRED · 0% AMBIGUOUS · INFERRED: 707 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `4553ff47`
...
Cohesion: 0.01
Nodes (515): addSymptomLabel(), addSymptomNote(), addSymptomNotePlaceholder(), addSymptomObservedAt(), addSymptomSeveritySevereSrPrefix(), addSymptomSubmit(), addSymptomTitle(), aideNavLabel() (+507 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (215): addSymptomLabel(), addSymptomNote(), addSymptomNotePlaceholder(), addSymptomTitle(), allergenDialogBadgeFromMonths(), allergenDialogClose(), allergenDialogHowToOfferTitle(), aujourdhuiAllergensTodo() (+207 more)

### Community 2 - "Community 2"
Cohesion: 0.01
Nodes (215): addSymptomLabel(), addSymptomNote(), addSymptomObservedAt(), addSymptomSubmit(), allergenDialogHowToOfferTitle(), allergenDialogSevereSignsTitle(), allergenDialogSourcesTitle(), allergenDialogTitle() (+207 more)

### Community 3 - "Community 3"
Cohesion: 0.01
Nodes (280): addSymptomObservedAt(), addSymptomSeveritySevereSrPrefix(), addSymptomSubmit(), allergenDialogFirstSignsTitle(), allergenDialogSevereSignsTitle(), allergenDialogSeverityMajor(), allergenDialogSourcesTitle(), allergenDialogTitle() (+272 more)

### Community 4 - "Community 4"
Cohesion: 0.01
Nodes (280): addSymptomNotePlaceholder(), addSymptomSeveritySevereSrPrefix(), addSymptomTitle(), allergenDialogBadgeFromMonths(), allergenDialogClose(), allergenDialogFirstSignsTitle(), allergenDialogSeverityMajor(), allergenPassportFadingHint (+272 more)

### Community 5 - "Community 5"
Cohesion: 0.08
Nodes (52): load(), foodEntries, makeDeleteEvent(), makeFormEvent(), setup(), exportSpy, loadFor(), setup() (+44 more)

### Community 6 - "Community 6"
Cohesion: 0.06
Nodes (59): seed(), VALID_THEMES, memberships, users, actions, seed(), seed(), actions (+51 more)

### Community 7 - "Community 7"
Cohesion: 0.07
Nodes (56): PASSKEY_AUTOFILL_OPTIONS_LIMIT, PASSKEY_OPTIONS_LIMIT, POST(), deleteSchema, load(), renameSchema, requireFreshAuth(), AuthenticationResult (+48 more)

### Community 8 - "Community 8"
Cohesion: 0.06
Nodes (46): getAllStagesForBento(), getStageForAgeMonths(), execRows(), Executor, db, drizzleDb, pool, sqlite (+38 more)

### Community 9 - "Community 9"
Cohesion: 0.08
Nodes (50): load(), countNthExposition(), listSymptomsByEntry(), load(), addSchema, formatDate(), formatTime(), load() (+42 more)
...
Cohesion: 0.1
Nodes (13): filterIncomingBreadcrumb(), ScrubbableEvent, scrubEvent(), scrubPathname(), scrubUrlString(), setLanguageTag(), listMembershipsForUser(), handle() (+5 more)
...
Cohesion: 0.17
Nodes (14): FORBIDDEN_FOODS, categoryLabel(), computeReminders(), push(), Reminder, Severity, SEVERITY_RANK, findRepeatCandidates() (+6 more)
...
- **Why does `languageTag()` connect `Community 0` to `Community 9`, `Community 28`, `Community 25`?**
  _High betweenness centrality (0.079) - this node is a cross-community bridge._
- **Why does `localizedHref()` connect `Community 28` to `Community 16`, `Community 0`?**
  _High betweenness centrality (0.013) - this node is a cross-community bridge._
- **Why does `handleOnline()` connect `Community 37` to `Community 66`?**
