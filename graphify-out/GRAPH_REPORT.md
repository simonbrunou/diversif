...
## Corpus Check
- 408 files · ~444,511 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1876 nodes · 2560 edges · 239 communities (179 shown, 60 thin omitted)
- Extraction: 82% EXTRACTED · 18% INFERRED · 0% AMBIGUOUS · INFERRED: 450 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `cfa91dbb`
...
## Communities (239 total, 60 thin omitted)

### Community 0 - "i18n Messages (auth.*)"
Cohesion: 0.01
Nodes (278): aujourdhuiAllergensOk(), aujourdhuiAllergensTitle(), aujourdhuiAllergensTodo(), aujourdhuiHeroEmptyBody(), aujourdhuiHeroEmptyCta(), aujourdhuiHeroEmptyTitle(), aujourdhuiHeroSuggestionCta(), aujourdhuiHeroSuggestionStage() (+270 more)

### Community 3 - "Page Loaders & Form Actions"
Cohesion: 0.06
Nodes (39): load(), allergens load test, findActiveInvitation(), load(), userHasMembership(), isUniqueViolation(), countNthExposition(), insertSymptom() (+31 more)

### Community 4 - "Test Fixtures & Setup Helpers"
Cohesion: 0.07
Nodes (45): load(), seed(), load(), seedTestUser(), POST(), createSession(), findUserByEmail(), getDecoyHash() (+37 more)
...
- **Why does `languageTag()` connect `i18n Messages (auth.*)` to `Offline Log Queue (IndexedDB)`, `Community 60`, `Community 62`?**
