...
## Corpus Check
- 462 files · ~689,498 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4463 nodes · 9067 edges · 166 communities (153 shown, 13 thin omitted)
...
- `requireGuest()` --calls--> `localizedRedirect()`  [INFERRED]
  src/lib/server/guards.ts → src/lib/server/redirect.ts

## Communities (166 total, 13 thin omitted)

### Community 0 - "i18n Messages (auth.*)"
Cohesion: 0.01
Nodes (235): addSymptomLabel(), addSymptomNote(), addSymptomNotePlaceholder(), addSymptomObservedAt(), addSymptomTitle(), allergenDialogClose(), allergenDialogHowToOfferTitle(), allergenDialogSeverityMajor() (+227 more)

### Community 1 - "i18n Messages (chrome.*)"
Cohesion: 0.01
Nodes (123): addSymptomSubmit(), allergenDialogBadgeFromMonths(), allergenDialogFirstSignsTitle(), allergenDialogSevereSignsTitle(), allergenDialogTitle(), aujourdhuiAllergensFading(), aujourdhuiAllergensOk(), aujourdhuiBilanStreak() (+115 more)

### Community 2 - "i18n Messages (errors+log+landing)"
Cohesion: 0.01
Nodes (172): addSymptomLabel(), addSymptomNote(), addSymptomTitle(), allergenDialogBadgeFromMonths(), allergenDialogClose(), allergenDialogFirstSignsTitle(), allergenDialogSevereSignsTitle(), allergenDialogSeverityMajor() (+164 more)

### Community 3 - "Page Loaders & Form Actions"
Cohesion: 0.01
Nodes (172): addSymptomLabel(), allergenDialogFirstSignsTitle(), allergenDialogSevereSignsTitle(), allergenDialogSeverityMajor(), allergenDialogSourcesTitle(), allergenDialogTitle(), aujourdhuiAllergensOk(), aujourdhuiAllergensTitle() (+164 more)

### Community 4 - "Test Fixtures & Setup Helpers"
Cohesion: 0.01
Nodes (140): addSymptomNote(), addSymptomObservedAt(), addSymptomSubmit(), addSymptomTitle(), allergenDialogHowToOfferTitle(), allergenDialogWhyEarlyTitle(), aujourdhuiBilanAlimentsDelta(), aujourdhuiRecentEmptyCta() (+132 more)

### Community 5 - "Branding, App Shell & PWA Manifest"
Cohesion: 0.01
Nodes (139): addSymptomNotePlaceholder(), addSymptomObservedAt(), addSymptomSeveritySevereSrPrefix(), allergenDialogTitle(), aujourdhuiAllergensTodo(), aujourdhuiBilanStreakDaysOther(), aujourdhuiRecentEmptyBody(), aujourdhuiRecentEmptyCta() (+131 more)

### Community 6 - "Architecture Patterns & Conventions"
Cohesion: 0.01
Nodes (189): addSymptomSubmit(), allergenDialogHowToOfferTitle(), allergenPassportFadingHint, allergenPassportSectionOther, allergenPassportSectionPriority, allergenPassportStateCleared, allergenPassportStateFading, allergenPassportStateReaction (+181 more)

### Community 7 - "Auth Routes & i18n Routing"
Cohesion: 0.01
Nodes (188): addSymptomNotePlaceholder(), addSymptomSeveritySevereSrPrefix(), allergenDialogBadgeFromMonths(), allergenDialogClose(), allergenPassportFadingHint, allergenPassportSectionOther, allergenPassportSectionPriority, allergenPassportStateCleared (+180 more)

### Community 8 - "UI Components & Tests"
Cohesion: 0.04
Nodes (70): load(), seed(), VALID_THEMES, memberships, users, actions, load(), seed() (+62 more)

### Community 9 - "WebAuthn / Passkeys"
Cohesion: 0.08
Nodes (54): load(), foodEntries, foods, symptoms, makeDeleteEvent(), makeFormEvent(), setup(), loadFor() (+46 more)

### Community 10 - "Offline Log Queue (IndexedDB)"
Cohesion: 0.06
Nodes (54): hasUniqueShape(), isUniqueViolation(), db, drizzleDb, pool, sqlite, loadEntry(), schema (+46 more)

### Community 11 - "User Memory & Medical Audit"
Cohesion: 0.08
Nodes (19): @simplewebauthn/browser, svelte/elements, $app/environment, $app/forms, $app/navigation, $lib/forms/tracked-enhance, $lib/i18n, $lib/offline/uuid (+11 more)

### Community 12 - "SEO / JSON-LD Library"
Cohesion: 0.07
Nodes (54): PASSKEY_AUTOFILL_OPTIONS_LIMIT, PASSKEY_OPTIONS_LIMIT, POST(), actions, deleteSchema, load(), renameSchema, auditSpy (+46 more)
...
Cohesion: 0.07
Nodes (16): filtered, FRUITS, streakLabel, $lib/content/did-you-know, $lib/content/recipes, $lib/server/guidance/reminders, $lib/types, $lib/utils/categories (+8 more)

### Community 18 - "Legal Pages"
Cohesion: 0.11
Nodes (25): execRows(), Executor, NOW, actions, AllergenSummary, load(), dismissReminder(), loadDismissals() (+17 more)
...
Cohesion: 0.06
Nodes (32): autoincrement, name, notNull, primaryKey, type, child_id, created_at, expires_at (+24 more)
...
Cohesion: 0.15
Nodes (23): SEVERE, Severity, severityOf(), SYMPTOM_LABELS, SymptomLabel, WARN, countNthExposition(), deleteSymptomById() (+15 more)
...
Cohesion: 0.1
Nodes (5): baseClass, $lib/utils/monitor-timer, $lib/utils/texture-labels, $lib/utils/textures, ./TextureTimeline.svelte
...
Cohesion: 0.14
Nodes (15): Stage, resolveMessageKey(), trackSubmission(), AllergenReportRow, load(), ReportEntry, ReportFood, $lib/paraglide/messages.js (+7 more)

### Community 49 - "Community 49"
Cohesion: 0.15
Nodes (12): filterIncomingBreadcrumb(), ScrubbableEvent, scrubEvent(), scrubPathname(), scrubUrlString(), enforceLanguageTag(), isAvailableLanguageTag(), languageTag() (+4 more)
...
Cohesion: 0.13
Nodes (3): baseProps, $lib/content/symptoms, $lib/utils/reactions
...
Cohesion: 0.27
Nodes (9): actions, ActiveInvite, checkJoinInviteLookupLimit(), findActiveInvitation(), load(), userHasMembership(), ./$types, generateInviteCodeRaw() (+1 more)
...
Cohesion: 0.24
Nodes (9): Membership, User, RecentEntry, SafeUser, SymptomEntry, fakeUser, insertUserWithPassword(), Locals (+1 more)
...
Cohesion: 0.6
Nodes (3): InsertSymptomResult, getReactionLabel(), ReactionId
...
- **Why does `languageTag()` connect `Community 49` to `i18n Messages (auth.*)`, `Community 97`, `Reminders Engine`, `i18n Messages (chrome.*)`?**
  _High betweenness centrality (0.080) - this node is a cross-community bridge._
- **Why does `devDependencies` connect `Allergens & Milestones` to `Community 101`?**
  _High betweenness centrality (0.013) - this node is a cross-community bridge._
- **Why does `svelte` connect `Allergens & Milestones` to `UI Component Library`?**
  _High betweenness centrality (0.013) - this node is a cross-community bridge._
