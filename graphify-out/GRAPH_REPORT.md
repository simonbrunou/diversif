# Graph Report - agent-ae4990e53ad361324  (2026-06-11)

## Corpus Check
- 458 files · ~375,216 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4569 nodes · 8585 edges · 156 communities (142 shown, 14 thin omitted)
- Extraction: 91% EXTRACTED · 9% INFERRED · 0% AMBIGUOUS · INFERRED: 803 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `786aee9a`
...
Cohesion: 0.01
Nodes (171): addSymptomSeveritySevereSrPrefix(), addSymptomTitle(), allergenDialogClose(), allergenDialogFirstSignsTitle(), allergenDialogSevereSignsTitle(), allergenDialogTitle(), allergenDialogWhyEarlyTitle(), aujourdhuiAllergensFading() (+163 more)

### Community 2 - "i18n Messages (errors+log+landing)"
Cohesion: 0.01
Nodes (171): addSymptomLabel(), addSymptomNote(), addSymptomNotePlaceholder(), addSymptomSeveritySevereSrPrefix(), allergenDialogClose(), allergenDialogFirstSignsTitle(), aujourdhuiBilanStreakDaysOther(), aujourdhuiRecentEmpty() (+163 more)

### Community 3 - "Page Loaders & Form Actions"
Cohesion: 0.01
Nodes (324): addSymptomLabel(), addSymptomNote(), addSymptomNotePlaceholder(), addSymptomObservedAt(), addSymptomSubmit(), allergenDialogBadgeFromMonths(), allergenDialogHowToOfferTitle(), allergenDialogSeverityMajor() (+316 more)

### Community 4 - "Test Fixtures & Setup Helpers"
Cohesion: 0.01
Nodes (324): addSymptomObservedAt(), addSymptomSubmit(), addSymptomTitle(), allergenDialogBadgeFromMonths(), allergenDialogHowToOfferTitle(), allergenDialogSevereSignsTitle(), allergenDialogSeverityMajor(), allergenDialogSourcesTitle() (+316 more)

### Community 5 - "Branding, App Shell & PWA Manifest"
Cohesion: 0.07
Nodes (60): load(), foodEntries, foods, symptoms, makeDeleteEvent(), makeFormEvent(), setup(), exportSpy (+52 more)

### Community 6 - "Architecture Patterns & Conventions"
Cohesion: 0.04
Nodes (66): seed(), Session, actions, load(), seed(), seed(), actions, load() (+58 more)

### Community 7 - "Auth Routes & i18n Routing"
Cohesion: 0.06
Nodes (51): getAllStagesForBento(), getStageForAgeMonths(), execRows(), Executor, db, drizzleDb, pool, sqlite (+43 more)

### Community 8 - "UI Components & Tests"
Cohesion: 0.07
Nodes (55): countNthExposition(), listSymptomsByEntry(), addSchema, formatDate(), formatTime(), load(), loadEntry(), loadEntryForChild() (+47 more)

### Community 9 - "WebAuthn / Passkeys"
Cohesion: 0.08
Nodes (51): load(), VALID_THEMES, PASSKEY_AUTOFILL_OPTIONS_LIMIT, PASSKEY_OPTIONS_LIMIT, POST(), actions, deleteSchema, load() (+43 more)

### Community 10 - "Offline Log Queue (IndexedDB)"
Cohesion: 0.07
Nodes (51): Child, children, Food, FoodEntry, IdempotencyKey, idempotencyKeys, Invitation, invitations (+43 more)
...
Cohesion: 0.05
Nodes (50): ALLERGEN_GUIDANCE, AllergenGuidance, APPROACHES, BentoStage, CATEGORY_GUIDANCE, CategoryGuidance, CHOKING_HAZARDS, ChokingHazard (+42 more)

### Community 13 - "UI Component Library"
Cohesion: 0.06
Nodes (4): baseProps, foods, $lib/utils/monitor-timer, textSnippet()

### Community 14 - "Account Export / Delete"
Cohesion: 0.09
Nodes (6): filtered, baseClass, $lib/types, $lib/utils/cn, $lib/utils/texture-labels, $lib/utils/textures
...
Cohesion: 0.08
Nodes (28): SEVERE, Severity, severityOf(), SYMPTOM_LABELS, SymptomLabel, WARN, Membership, User (+20 more)
...
Cohesion: 0.07
Nodes (19): handler(), drainPool(), EndablePool, Logger, registerShutdownHandlers(), _resetShutdownState(), ShutdownOptions, makeHarness() (+11 more)
...
Cohesion: 0.06
Nodes (31): food_id, logged_by, notes, reaction, texture, columns, autoincrement, name (+23 more)
...
Cohesion: 0.07
Nodes (27): invitations_child_id_children_id_fk, invitations_created_by_users_id_fk, invitations_expires_at_idx, checkConstraints, columnsFrom, columnsTo, name, onDelete (+19 more)
...
Cohesion: 0.08
Nodes (26): autoincrement, name, notNull, primaryKey, type, backed_up, device_type, last_used_at (+18 more)
...
Cohesion: 0.09
Nodes (11): user, ../app.css, $lib/offline/queue, $lib/utils/theme, bentoKids, firstChildId, isAccountRoute, locale (+3 more)
...
Cohesion: 0.1
Nodes (6): $lib/content/symptoms, $lib/paraglide/runtime, $lib/utils/age, $lib/utils/categories, $lib/utils/reactions, $lib/utils/search
...
Cohesion: 0.13
Nodes (8): resolveMessageKey(), trackSubmission(), $lib/paraglide/messages.js, $lib/server/guidance/allergen-status, $lib/utils/suggest, SuggestFood, getTextureLabel(), LABEL_FNS
...
- **Why does `languageTag()` connect `i18n Messages (auth.*)` to `UI Components & Tests`, `Reaction Reports & Reminders`, `UI Primitives & LEAP/EAT Cards`?**
  _High betweenness centrality (0.084) - this node is a cross-community bridge._
- **Why does `localizedHref()` connect `UI Primitives & LEAP/EAT Cards` to `i18n Messages (auth.*)`, `Invitations & Memberships`?**
  _High betweenness centrality (0.016) - this node is a cross-community bridge._
- **Why does `devDependencies` connect `Allergens & Milestones` to `Community 85`?**
