# Graph Report - diversif  (2026-05-22)

## Corpus Check
- 478 files · ~692,475 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2794 nodes · 5106 edges · 186 communities (174 shown, 12 thin omitted)
- Extraction: 89% EXTRACTED · 11% INFERRED · 0% AMBIGUOUS · INFERRED: 579 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `8ccf0266`
...
Cohesion: 0.01
Nodes (357): addSymptomLabel(), addSymptomNote(), addSymptomNotePlaceholder(), addSymptomObservedAt(), addSymptomSubmit(), addSymptomTitle(), allergenDialogBadgeFromMonths(), allergenDialogClose() (+349 more)

### Community 1 - "i18n Messages (chrome.*)"
Cohesion: 0.01
Nodes (105): addSymptomNote(), allergenDialogHowToOfferTitle(), aujourdhuiAllergensTodo(), aujourdhuiRecentEmpty(), aujourdhuiRecentTitle(), aujourdhuiStatsStreakDaysOne(), aujourdhuiStatsStreakDaysOther(), authAccountDataExport() (+97 more)

### Community 2 - "i18n Messages (errors+log+landing)"
Cohesion: 0.01
Nodes (105): addSymptomNote(), addSymptomObservedAt(), addSymptomSubmit(), allergenDialogHowToOfferTitle(), allergenDialogSevereSignsTitle(), allergenDialogWhyEarlyTitle(), aujourdhuiBilanStreak(), aujourdhuiBilanStreakDaysOne() (+97 more)

### Community 3 - "Page Loaders & Form Actions"
Cohesion: 0.01
Nodes (296): addSymptomLabel(), addSymptomNotePlaceholder(), addSymptomObservedAt(), addSymptomSubmit(), addSymptomTitle(), allergenDialogBadgeFromMonths(), allergenDialogClose(), allergenDialogFirstSignsTitle() (+288 more)

### Community 4 - "Test Fixtures & Setup Helpers"
Cohesion: 0.01
Nodes (296): addSymptomLabel(), addSymptomNotePlaceholder(), addSymptomTitle(), allergenDialogBadgeFromMonths(), allergenDialogClose(), allergenDialogFirstSignsTitle(), allergenDialogSeverityMajor(), allergenDialogSourcesTitle() (+288 more)

### Community 5 - "Branding, App Shell & PWA Manifest"
Cohesion: 0.01
Nodes (45): authAccountAppearanceDescription(), authAccountDeletePasswordLabel(), authAccountDeleteSection(), authAccountGroupSessions(), authAccountLegalSection(), authAccountPasskeyAdd(), authAccountPasskeyRenameButton(), authAccountPasskeyUnsupported() (+37 more)

### Community 6 - "Architecture Patterns & Conventions"
Cohesion: 0.05
Nodes (55): seed(), seed(), makeDeleteEvent(), makeFormEvent(), setup(), loadFor(), setup(), setupEgg() (+47 more)

### Community 7 - "Auth Routes & i18n Routing"
Cohesion: 0.06
Nodes (41): load(), GET(), POST(), load(), audit(), deleteUserAccount(), ExportTooLargeError, exportUserData() (+33 more)
...
Cohesion: 0.12
Nodes (17): load(), load(), load(), load(), findUserByEmail(), invalidateAllUserSessions(), setSessionCookie(), verifyPassword() (+9 more)
...
Cohesion: 0.12
Nodes (10): axeSweep(), formatViolations(), dismissWelcomeIfPresent(), expectBottomSheet(), expectDialogMatchesViewport(), expectNotBottomSheet(), signUp(), signUpAndCreateChild() (+2 more)
...
Cohesion: 0.2
Nodes (13): load(), load(), load(), LogActionAbort, load(), parseChildIdParam(), requireChildContext(), requireMembership() (+5 more)

### Community 15 - "DB Init, Backup & Seed"
Cohesion: 0.13
Nodes (15): severityOf(), countNthExposition(), deleteSymptomById(), insertSymptom(), formatDate(), formatTime(), load(), loadEntry() (+7 more)

### Community 16 - "Allergens & Milestones"
Cohesion: 0.16
Nodes (13): dismissReminder(), loadAnalyticsBuckets(), loadCoparentActivity(), loadDismissals(), loadDiversityMetrics(), loadRecentEntries(), loadStreak(), loadTexturesTried() (+5 more)

### Community 17 - "Sentry Observability"
Cohesion: 0.16
Nodes (12): getAllStagesForBento(), getStageForAgeMonths(), getTipsFor(), pickRotatingTip(), getRecipesForStage(), getSeasonalNames(), loadSeasonalFoods(), loadTextureProgress() (+4 more)
...
Cohesion: 0.16
Nodes (11): load(), loadBentoAllergens(), loadWeeklyEntries(), loadAllergenStatus(), loadRepeatCandidates(), loadDiversityMetrics(), loadRepeatCandidates(), loadWeeklyRecap() (+3 more)

### Community 21 - "Diversification Guidance & Stages"
Cohesion: 0.21
Nodes (8): filterIncomingBreadcrumb(), scrubEvent(), scrubPathname(), scrubUrlString(), enforceLanguageTag(), isAvailableLanguageTag(), onSetLanguageTag(), setLanguageTag()

### Community 22 - "UI Primitives & LEAP/EAT Cards"
Cohesion: 0.21
Nodes (9): listSymptomsByEntry(), load(), load(), ageInMonths(), formatAge(), toEpochMs(), defaultTextureForAgeMonths(), getTextureLabel() (+1 more)
...
Cohesion: 0.24
Nodes (7): runCleanup(), startCleanupTimer(), stopCleanupTimer(), IdempotencyInFlight, IdempotencyScopeMismatch, pruneExpiredKeys(), withIdempotencyKey()
...
Cohesion: 0.29
Nodes (8): load(), formatDateInputValue(), formatDateTime(), formatMonthsSince(), formatRelative(), isValidBirthDate(), localInputToIso(), parseDateTimeLocal()
...
- **Why does `languageTag()` connect `i18n Messages (auth.*)` to `UI Components & Tests`, `Diversification Guidance & Stages`, `Branding, App Shell & PWA Manifest`, `Diversity Metrics`?**
  _High betweenness centrality (0.141) - this node is a cross-community bridge._
- **Why does `setLanguageTag()` connect `Diversification Guidance & Stages` to `i18n Messages (auth.*)`, `Diversity Metrics`, `Architecture Patterns & Conventions`?**
