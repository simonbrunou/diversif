...
## Corpus Check
- 273 files · ~370,489 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1546 nodes · 2138 edges · 181 communities (127 shown, 54 thin omitted)
- Extraction: 83% EXTRACTED · 17% INFERRED · 0% AMBIGUOUS · INFERRED: 372 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `041c93cc`
...
Cohesion: 0.05
Nodes (49): load(), allergens load test, load(), findActiveInvitation(), load(), userHasMembership(), load(), loadEntry() (+41 more)
...
- **Why does `languageTag()` connect `i18n Messages (auth.*)` to `WebAuthn / Passkeys`, `Community 51`?**
