...
Cohesion: 0.01
Nodes (241): addSymptomLabel(), addSymptomNote(), addSymptomNotePlaceholder(), allergenDialogBadgeFromMonths(), allergenDialogFirstSignsTitle(), allergenDialogSevereSignsTitle(), allergenDialogSeverityMajor(), allergenDialogSourcesTitle() (+233 more)

### Community 1 - "i18n Messages (chrome.*)"
Cohesion: 0.01
Nodes (117): addSymptomObservedAt(), addSymptomSubmit(), addSymptomTitle(), allergenDialogClose(), allergenDialogHowToOfferTitle(), allergenDialogWhyEarlyTitle(), aujourdhuiBilanAlimentsDelta(), aujourdhuiBilanStreakRecord() (+109 more)

### Community 2 - "i18n Messages (errors+log+landing)"
Cohesion: 0.01
Nodes (174): addSymptomNotePlaceholder(), addSymptomSubmit(), addSymptomTitle(), allergenDialogBadgeFromMonths(), allergenDialogFirstSignsTitle(), allergenDialogSeverityMajor(), aujourdhuiAllergensTitle(), aujourdhuiBilanAliments() (+166 more)

### Community 3 - "Page Loaders & Form Actions"
Cohesion: 0.01
Nodes (174): addSymptomNotePlaceholder(), addSymptomObservedAt(), addSymptomTitle(), allergenDialogClose(), allergenDialogHowToOfferTitle(), allergenDialogSeverityMajor(), allergenDialogSourcesTitle(), allergenDialogTitle() (+166 more)

### Community 4 - "Test Fixtures & Setup Helpers"
Cohesion: 0.01
Nodes (133): allergenDialogHowToOfferTitle(), allergenDialogSevereSignsTitle(), allergenDialogSourcesTitle(), aujourdhuiAllergensFading(), aujourdhuiBilanStreak(), aujourdhuiBilanStreakRecord(), aujourdhuiRecentEmptyCta(), authAccountDeleteConfirmLabel() (+125 more)

### Community 5 - "Branding, App Shell & PWA Manifest"
Cohesion: 0.01
Nodes (133): addSymptomLabel(), addSymptomNote(), allergenDialogFirstSignsTitle(), aujourdhuiBilanStreakDaysOne(), aujourdhuiRecentEmpty(), authAccountDeleteConfirmLabel(), authAccountDeleteSubmitting(), authAccountLogoutEverywhere() (+125 more)

### Community 6 - "Architecture Patterns & Conventions"
Cohesion: 0.01
Nodes (193): addSymptomLabel(), addSymptomNote(), addSymptomObservedAt(), addSymptomSeveritySevereSrPrefix(), allergenDialogClose(), allergenDialogTitle(), allergenDialogWhyEarlyTitle(), allergenPassportFadingHint (+185 more)

### Community 7 - "Auth Routes & i18n Routing"
Cohesion: 0.01
Nodes (193): addSymptomSeveritySevereSrPrefix(), addSymptomSubmit(), allergenDialogBadgeFromMonths(), allergenDialogSevereSignsTitle(), allergenPassportFadingHint, allergenPassportSectionOther, allergenPassportSectionPriority, allergenPassportStateCleared (+185 more)

### Community 8 - "UI Components & Tests"
Cohesion: 0.07
Nodes (54): load(), foodEntries, foods, symptoms, makeDeleteEvent(), makeFormEvent(), setup(), exportSpy (+46 more)

### Community 9 - "WebAuthn / Passkeys"
Cohesion: 0.06
Nodes (66): db, countNthExposition(), listSymptomsByEntry(), addSchema, formatDate(), formatTime(), load(), loadEntry() (+58 more)

### Community 10 - "Offline Log Queue (IndexedDB)"
Cohesion: 0.05
Nodes (61): seed(), VALID_THEMES, actions, load(), seed(), seed(), actions, load() (+53 more)

### Community 11 - "User Memory & Medical Audit"
Cohesion: 0.06
Nodes (53): Child, children, Food, FoodEntry, IdempotencyKey, idempotencyKeys, Invitation, invitations (+45 more)

### Community 12 - "SEO / JSON-LD Library"
Cohesion: 0.07
Nodes (49): load(), PASSKEY_AUTOFILL_OPTIONS_LIMIT, PASSKEY_OPTIONS_LIMIT, POST(), actions, deleteSchema, load(), renameSchema (+41 more)

### Community 13 - "UI Component Library"
Cohesion: 0.07
Nodes (38): execRows(), Executor, drizzleDb, pool, sqlite, AnyDb, applySeedCorrections(), FOODS_SEED (+30 more)
...
Cohesion: 0.06
Nodes (13): filtered, baseClass, FRUITS, $lib/paraglide/runtime, $lib/utils/age, $lib/utils/categories, $lib/utils/cn, $lib/utils/reactions (+5 more)
...
Cohesion: 0.09
Nodes (27): FORBIDDEN_FOODS, categoryLabel(), computeReminders(), push(), Reminder, ReminderInput, Severity, SEVERITY_RANK (+19 more)
...
Cohesion: 0.12
Nodes (21): SEVERE, Severity, severityOf(), SYMPTOM_LABELS, SymptomLabel, WARN, Membership, User (+13 more)
...
Cohesion: 0.12
Nodes (14): #each(), introducedCount, other, stateIcon(), FULL_TWELVE, $lib/content/did-you-know, $lib/content/recipes, $lib/server/guidance/allergen-status (+6 more)
...
Cohesion: 0.31
Nodes (7): Bucket, bucketKey(), evictExpiredRateLimits(), RateLimitOptions, RateLimitResult, resetRateLimit(), store
...
Cohesion: 0.38
Nodes (5): actions, load(), profileSchema, seed(), ./$types
...
- **Why does `languageTag()` connect `Community 46` to `i18n Messages (auth.*)`, `WebAuthn / Passkeys`, `Community 42`, `i18n Messages (chrome.*)`?**
  _High betweenness centrality (0.084) - this node is a cross-community bridge._
- **Why does `devDependencies` connect `Invitations & Memberships` to `Community 94`?**
  _High betweenness centrality (0.013) - this node is a cross-community bridge._
- **Why does `svelte` connect `Invitations & Memberships` to `Account Export / Delete`?**
  _High betweenness centrality (0.013) - this node is a cross-community bridge._
