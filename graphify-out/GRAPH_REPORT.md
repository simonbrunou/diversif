# Graph Report - diversif  (2026-06-04)

## Corpus Check
- 459 files · ~419,417 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4443 nodes · 9020 edges · 171 communities (155 shown, 16 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 193 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `92eb48dc`
...
Cohesion: 0.01
Nodes (241): addSymptomNote(), addSymptomNotePlaceholder(), addSymptomObservedAt(), addSymptomSubmit(), addSymptomTitle(), allergenDialogBadgeFromMonths(), allergenDialogClose(), allergenDialogFirstSignsTitle() (+233 more)

### Community 1 - "i18n Messages (chrome.*)"
Cohesion: 0.01
Nodes (117): addSymptomLabel(), allergenDialogSevereSignsTitle(), allergenDialogSeverityMajor(), aujourdhuiAllergensOk(), aujourdhuiAllergensTitle(), aujourdhuiRecentTitle(), authAccountDeleteConfirmLabel(), authAccountDeleteDescription() (+109 more)

### Community 2 - "i18n Messages (errors+log+landing)"
Cohesion: 0.01
Nodes (175): addSymptomLabel(), addSymptomNotePlaceholder(), addSymptomObservedAt(), allergenDialogBadgeFromMonths(), allergenDialogClose(), allergenDialogFirstSignsTitle(), allergenDialogSeverityMajor(), allergenDialogWhyEarlyTitle() (+167 more)

### Community 3 - "Page Loaders & Form Actions"
Cohesion: 0.01
Nodes (174): addSymptomLabel(), addSymptomObservedAt(), addSymptomSubmit(), allergenDialogSeverityMajor(), allergenDialogSourcesTitle(), allergenDialogWhyEarlyTitle(), aujourdhuiAllergensFading(), aujourdhuiAllergensOk() (+166 more)

### Community 4 - "Test Fixtures & Setup Helpers"
Cohesion: 0.01
Nodes (134): addSymptomNote(), allergenDialogClose(), allergenDialogSevereSignsTitle(), allergenDialogTitle(), aujourdhuiBilanAliments(), aujourdhuiBilanAlimentsDelta(), aujourdhuiBilanStreakDaysOther(), aujourdhuiRecentTitle() (+126 more)

### Community 5 - "Branding, App Shell & PWA Manifest"
Cohesion: 0.01
Nodes (134): addSymptomNote(), allergenDialogTitle(), aujourdhuiBilanAliments(), authAccountAppearanceSection(), authAccountDeleteSubmitting(), authAccountLogout(), authAccountPasskeyAddedOn(), authAccountPasskeyDeleteButton() (+126 more)

### Community 6 - "Architecture Patterns & Conventions"
Cohesion: 0.01
Nodes (192): addSymptomNotePlaceholder(), addSymptomSeveritySevereSrPrefix(), addSymptomTitle(), allergenDialogBadgeFromMonths(), allergenDialogFirstSignsTitle(), allergenDialogHowToOfferTitle(), allergenPassportFadingHint, allergenPassportSectionOther (+184 more)

### Community 7 - "Auth Routes & i18n Routing"
Cohesion: 0.01
Nodes (191): addSymptomSeveritySevereSrPrefix(), addSymptomSubmit(), addSymptomTitle(), allergenDialogHowToOfferTitle(), allergenDialogSevereSignsTitle(), allergenDialogSourcesTitle(), allergenPassportFadingHint, allergenPassportSectionOther (+183 more)
...
Cohesion: 0.05
Nodes (63): seed(), VALID_THEMES, memberships, users, actions, seed(), seed(), actions (+55 more)

### Community 10 - "Offline Log Queue (IndexedDB)"
Cohesion: 0.07
Nodes (58): countNthExposition(), listSymptomsByEntry(), load(), addSchema, formatDate(), formatTime(), load(), loadEntry() (+50 more)

### Community 11 - "User Memory & Medical Audit"
Cohesion: 0.06
Nodes (46): execRows(), Executor, db, drizzleDb, pool, sqlite, tipDismissals, AnyDb (+38 more)

### Community 12 - "SEO / JSON-LD Library"
Cohesion: 0.08
Nodes (50): load(), PASSKEY_AUTOFILL_OPTIONS_LIMIT, PASSKEY_OPTIONS_LIMIT, POST(), deleteSchema, load(), renameSchema, requireFreshAuth() (+42 more)
...
Cohesion: 0.06
Nodes (45): Child, children, Food, FoodEntry, IdempotencyKey, Invitation, invitations, NewChild (+37 more)

### Community 15 - "DB Init, Backup & Seed"
Cohesion: 0.07
Nodes (12): FRUITS, $lib/content/did-you-know, $lib/content/recipes, $lib/types, $lib/utils/suggest, $lib/utils/texture-labels, ./$types, ./DidYouKnow.svelte (+4 more)
...
Cohesion: 0.13
Nodes (12): @simplewebauthn/browser, svelte/elements, $app/environment, $app/forms, $app/navigation, $lib/forms/tracked-enhance, $lib/offline/uuid, $lib/utils/dates (+4 more)

### Community 19 - "Invitations & Memberships"
Cohesion: 0.08
Nodes (28): SEVERE, Severity, severityOf(), SYMPTOM_LABELS, SymptomLabel, WARN, Membership, symptoms (+20 more)

### Community 20 - "SEO Source-of-Truth Config"
Cohesion: 0.13
Nodes (9): $lib/i18n, $lib/paraglide/messages, $lib/seo, $lib/utils/localized-href, $lib/utils/milestones, ./SourcesCluster.svelte, $app/state, Icon (+1 more)
...
Cohesion: 0.06
Nodes (31): food_id, given_at, logged_by, notes, reaction, columns, autoincrement, name (+23 more)
...
Cohesion: 0.09
Nodes (9): filtered, baseClass, $lib/utils/age, $lib/utils/categories, $lib/utils/cn, $lib/utils/reactions, $lib/utils/search, $lib/utils/textures (+1 more)
...
Cohesion: 0.12
Nodes (22): FORBIDDEN_FOODS, categoryLabel(), computeReminders(), push(), Reminder, ReminderInput, Severity, SEVERITY_RANK (+14 more)
...
Cohesion: 0.07
Nodes (27): invitations_created_by_users_id_fk, invitations_used_by_users_id_fk, invitations_expires_at_idx, checkConstraints, compositePrimaryKeys, columnsFrom, columnsTo, name (+19 more)
...
Cohesion: 0.08
Nodes (26): autoincrement, name, notNull, primaryKey, type, backed_up, counter, last_used_at (+18 more)
...
Cohesion: 0.13
Nodes (20): ALLERGEN_GUIDANCE, AllergenGuidance, APPROACHES, BentoStage, CATEGORY_GUIDANCE, CategoryGuidance, CHOKING_HAZARDS, ChokingHazard (+12 more)
...
Cohesion: 0.17
Nodes (14): Stage, AllergenReportRow, load(), ReportEntry, ReportFood, $lib/paraglide/messages.js, ./$types, getTextureLabel() (+6 more)
...
Cohesion: 0.16
Nodes (13): idempotencyKeys, LogActionAbort, schema, ./$types, Executor, ResolveFoodInput, ResolveFoodResult, resolveOrInsertFood() (+5 more)
...
Cohesion: 0.2
Nodes (12): actions, ActiveInvite, checkJoinInviteLookupLimit(), findActiveInvitation(), load(), userHasMembership(), hasUniqueShape(), isUniqueViolation() (+4 more)
...
Cohesion: 0.24
Nodes (12): getAllStagesForBento(), getStageForAgeMonths(), getRecipesForStage(), getSeasonalNames(), SEASONAL_FOODS_BY_MONTH, loadAllergenStatus(), load(), loadSeasonalFoods() (+4 more)
...
Cohesion: 0.18
Nodes (7): #each(), introducedCount, other, stateIcon(), FULL_TWELVE, $lib/server/guidance/allergen-status, ./AllergenPassport.svelte
...
Cohesion: 0.27
Nodes (9): CATEGORY_IDS, CATEGORY_LABEL_RESOLVERS, CategoryClasses, CategoryColor, CLASS_MAP, getCategoryClasses(), getCategoryColor(), getCategoryIcon() (+1 more)
...
Cohesion: 0.27
Nodes (6): logHref(), getAllergenLabel(), CATEGORY_THRESHOLDS, celebrate(), MilestoneKind, pickMilestoneFromQuery()
...
Cohesion: 0.29
Nodes (7): suggested_age_months, columns, autoincrement, name, notNull, primaryKey, type
...
- **Why does `languageTag()` connect `Community 45` to `i18n Messages (auth.*)`, `i18n Messages (chrome.*)`, `Offline Log Queue (IndexedDB)`, `Community 37`?**
  _High betweenness centrality (0.084) - this node is a cross-community bridge._
- **Why does `devDependencies` connect `Sentry Observability` to `Community 97`?**
  _High betweenness centrality (0.013) - this node is a cross-community bridge._
- **Why does `svelte` connect `Sentry Observability` to `UI Component Library`?**
  _High betweenness centrality (0.013) - this node is a cross-community bridge._
