...
## Corpus Check
- 450 files · ~373,041 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4442 nodes · 8391 edges · 155 communities (141 shown, 14 thin omitted)
- Extraction: 91% EXTRACTED · 9% INFERRED · 0% AMBIGUOUS · INFERRED: 766 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `663929c4`
...
Cohesion: 0.01
Nodes (573): addSymptomLabel(), addSymptomNote(), addSymptomNotePlaceholder(), addSymptomObservedAt(), addSymptomSeveritySevereSrPrefix(), addSymptomSubmit(), addSymptomTitle(), aideNavLabel() (+565 more)

### Community 1 - "i18n Messages (chrome.*)"
Cohesion: 0.01
Nodes (186): addSymptomNote(), addSymptomNotePlaceholder(), addSymptomSeveritySevereSrPrefix(), addSymptomTitle(), allergenDialogBadgeFromMonths(), allergenDialogClose(), allergenDialogFirstSignsTitle(), allergenDialogSevereSignsTitle() (+178 more)

### Community 2 - "i18n Messages (errors+log+landing)"
Cohesion: 0.01
Nodes (186): addSymptomNote(), allergenDialogClose(), allergenDialogFirstSignsTitle(), allergenDialogSeverityMajor(), aujourdhuiAllergensFading(), aujourdhuiAllergensOk(), aujourdhuiAllergensTodo(), aujourdhuiBilanStreakDaysOne() (+178 more)

### Community 3 - "Page Loaders & Form Actions"
Cohesion: 0.01
Nodes (309): addSymptomLabel(), addSymptomObservedAt(), addSymptomSubmit(), allergenDialogHowToOfferTitle(), allergenDialogTitle(), allergenDialogWhyEarlyTitle(), allergenPassportFadingHint, allergenPassportSectionOther (+301 more)

### Community 4 - "Test Fixtures & Setup Helpers"
Cohesion: 0.01
Nodes (309): addSymptomLabel(), addSymptomNotePlaceholder(), addSymptomObservedAt(), addSymptomSeveritySevereSrPrefix(), addSymptomSubmit(), addSymptomTitle(), allergenDialogBadgeFromMonths(), allergenDialogHowToOfferTitle() (+301 more)
...
Cohesion: 0.06
Nodes (57): load(), seed(), VALID_THEMES, users, actions, load(), seed(), seed() (+49 more)

### Community 8 - "UI Components & Tests"
Cohesion: 0.08
Nodes (42): PASSKEY_AUTOFILL_OPTIONS_LIMIT, PASSKEY_OPTIONS_LIMIT, POST(), AuthenticationResult, base64UrlToBuffer(), bufferToBase64Url(), buildAuthenticationOptions(), buildRegistrationOptions() (+34 more)
...
Cohesion: 0.12
Nodes (29): loadEntry(), parseEntryId(), schema, load(), load(), load(), LogActionAbort, schema (+21 more)

### Community 11 - "User Memory & Medical Audit"
Cohesion: 0.08
Nodes (13): ../app.css, $lib/i18n, $lib/offline/queue, $lib/paraglide/messages, $lib/paraglide/runtime, $lib/utils/localized-href, $lib/utils/milestones, $lib/utils/theme (+5 more)
...
Cohesion: 0.1
Nodes (25): idempotencyKeys, sessions, webauthnChallenges, makeAutofillEvent(), makeModalEvent(), CleanupResult, runCleanup(), startCleanupTimer() (+17 more)
...
Cohesion: 0.14
Nodes (21): execRows(), Executor, db, actions, AllergenSummary, load(), dismissReminder(), loadDismissals() (+13 more)
...
Cohesion: 0.06
Nodes (33): autoincrement, name, notNull, primaryKey, type, backed_up, counter, last_used_at (+25 more)

### Community 27 - "Auth Guards & Sessions"
Cohesion: 0.06
Nodes (33): autoincrement, name, notNull, primaryKey, type, category, custom_for_child_id, is_custom (+25 more)
...
Cohesion: 0.15
Nodes (22): getAllStagesForBento(), getStageForAgeMonths(), Stage, dayjs/locale/fr, loadAllergenStatus(), load(), AllergenReportRow, load() (+14 more)
...
Cohesion: 0.16
Nodes (11): filterIncomingBreadcrumb(), ScrubbableEvent, scrubEvent(), scrubPathname(), scrubUrlString(), enforceLanguageTag(), setLanguageTag(), listMembershipsForUser() (+3 more)
...
Cohesion: 0.16
Nodes (14): Executor, ResolveFoodInput, ResolveFoodResult, resolveOrInsertFood(), #each(), CATEGORY_IDS, CATEGORY_LABEL_RESOLVERS, CategoryClasses (+6 more)
...
Cohesion: 0.17
Nodes (10): actions, deleteSchema, load(), renameSchema, auditSpy, seed(), AuditEvent, deletePasskey() (+2 more)
...
Cohesion: 0.24
Nodes (7): load(), loadBentoAllergens(), loadWeeklyEntries(), AllergenItem, PRIORITY_SET, fuzzyMatch(), normalize()
...
Cohesion: 0.31
Nodes (6): $lib/paraglide/messages.js, getTextureLabel(), LABEL_FNS, defaultTextureForAgeMonths(), getTextureLabel(), TEXTURE_VALUES
...
Cohesion: 0.22
Nodes (3): { captureExceptionMock, initMock }, CookieOpts, { setLanguageTagMock }
...
- **Why does `languageTag()` connect `i18n Messages (auth.*)` to `Community 34`, `Community 46`, `Community 47`?**
  _High betweenness centrality (0.088) - this node is a cross-community bridge._
- **Why does `localizedHref()` connect `Community 46` to `i18n Messages (auth.*)`, `SEO Source-of-Truth Config`?**
  _High betweenness centrality (0.020) - this node is a cross-community bridge._
- **Why does `devDependencies` connect `UI Component Library` to `Community 96`?**
  _High betweenness centrality (0.009) - this node is a cross-community bridge._
- **Are the 575 inferred relationships involving `languageTag()` (e.g. with `formatRelative()` and `formatMonthsSince()`) actually correct?**
  _`languageTag()` has 575 INFERRED edges - model-reasoned connections that need verification._
