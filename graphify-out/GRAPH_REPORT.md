...
## Corpus Check
- 458 files · ~415,685 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4403 nodes · 8978 edges · 167 communities (152 shown, 15 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 193 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `cc5ccef3`
...
Cohesion: 0.01
Nodes (124): addSymptomLabel(), addSymptomNotePlaceholder(), addSymptomObservedAt(), addSymptomSubmit(), addSymptomTitle(), allergenDialogFirstSignsTitle(), allergenDialogTitle(), aujourdhuiBilanStreakDaysOne() (+116 more)

### Community 1 - "i18n Messages (chrome.*)"
Cohesion: 0.01
Nodes (234): addSymptomNote(), allergenDialogBadgeFromMonths(), allergenDialogClose(), allergenDialogHowToOfferTitle(), allergenDialogSevereSignsTitle(), allergenDialogSeverityMajor(), allergenDialogSourcesTitle(), allergenDialogWhyEarlyTitle() (+226 more)

### Community 2 - "i18n Messages (errors+log+landing)"
Cohesion: 0.01
Nodes (171): addSymptomLabel(), addSymptomNote(), allergenDialogBadgeFromMonths(), allergenDialogClose(), allergenDialogFirstSignsTitle(), allergenDialogSeverityMajor(), allergenDialogSourcesTitle(), aujourdhuiAllergensFading() (+163 more)

### Community 3 - "Page Loaders & Form Actions"
Cohesion: 0.01
Nodes (171): addSymptomLabel(), addSymptomTitle(), allergenDialogBadgeFromMonths(), allergenDialogFirstSignsTitle(), allergenDialogHowToOfferTitle(), allergenDialogSevereSignsTitle(), allergenDialogSourcesTitle(), allergenDialogTitle() (+163 more)

### Community 4 - "Test Fixtures & Setup Helpers"
Cohesion: 0.01
Nodes (140): addSymptomObservedAt(), addSymptomSubmit(), addSymptomTitle(), allergenDialogHowToOfferTitle(), allergenDialogWhyEarlyTitle(), aujourdhuiAllergensTitle(), aujourdhuiBilanStreakRecord(), aujourdhuiRecentEmptyBody() (+132 more)

### Community 5 - "Branding, App Shell & PWA Manifest"
Cohesion: 0.01
Nodes (140): addSymptomNote(), addSymptomNotePlaceholder(), addSymptomObservedAt(), addSymptomSeveritySevereSrPrefix(), aujourdhuiBilanStreakDaysOne(), aujourdhuiBilanStreakRecord(), aujourdhuiRecentEmpty(), authAccountNewPasswordLabel() (+132 more)

### Community 6 - "Architecture Patterns & Conventions"
Cohesion: 0.01
Nodes (189): addSymptomNotePlaceholder(), addSymptomSeveritySevereSrPrefix(), allergenDialogSevereSignsTitle(), allergenDialogTitle(), allergenPassportFadingHint, allergenPassportSectionOther, allergenPassportSectionPriority, allergenPassportStateCleared (+181 more)

### Community 7 - "Auth Routes & i18n Routing"
Cohesion: 0.01
Nodes (189): addSymptomSubmit(), allergenDialogClose(), allergenDialogSeverityMajor(), allergenPassportFadingHint, allergenPassportSectionOther, allergenPassportSectionPriority, allergenPassportStateCleared, allergenPassportStateFading (+181 more)
...
Cohesion: 0.05
Nodes (62): seed(), actions, load(), seed(), seed(), actions, load(), LOGIN_LIMIT (+54 more)

### Community 10 - "Offline Log Queue (IndexedDB)"
Cohesion: 0.06
Nodes (65): db, countNthExposition(), listSymptomsByEntry(), addSchema, formatDate(), formatTime(), load(), loadEntry() (+57 more)

### Community 11 - "User Memory & Medical Audit"
Cohesion: 0.06
Nodes (56): load(), VALID_THEMES, users, PASSKEY_AUTOFILL_OPTIONS_LIMIT, PASSKEY_OPTIONS_LIMIT, POST(), actions, deleteSchema (+48 more)
...
Cohesion: 0.09
Nodes (21): @simplewebauthn/browser, $app/environment, $app/forms, $app/navigation, $lib/forms/tracked-enhance, $lib/i18n, $lib/offline/uuid, $lib/paraglide/messages (+13 more)

### Community 14 - "Account Export / Delete"
Cohesion: 0.04
Nodes (44): FULL_TWELVE, drizzleDb, pool, sqlite, AnyDb, applySeedCorrections(), FOODS_SEED, SeedFood (+36 more)

### Community 15 - "DB Init, Backup & Seed"
Cohesion: 0.07
Nodes (46): Child, children, Food, FoodEntry, IdempotencyKey, Invitation, invitations, memberships (+38 more)
...
Cohesion: 0.08
Nodes (12): filtered, baseClass, FRUITS, svelte/elements, $lib/utils/categories, $lib/utils/cn, $lib/utils/reactions, $lib/utils/search (+4 more)

### Community 19 - "Invitations & Memberships"
Cohesion: 0.06
Nodes (6): streakLabel, baseProps, $lib/content/symptoms, $lib/server/guidance/reminders, $lib/types, $lib/utils/monitor-timer
...
Cohesion: 0.08
Nodes (5): i18n, $lib/utils/dates, reroute, cn(), localizedHref()
...
Cohesion: 0.11
Nodes (21): idempotencyKeys, webauthnChallenges, LogActionAbort, schema, ./$types, CleanupResult, runCleanup(), startCleanupTimer() (+13 more)
...
Cohesion: 0.14
Nodes (16): execRows(), Executor, dismissReminder(), loadDismissals(), ttlForReminderKey(), DiversityMetrics, RepeatCandidate, WeeklyRecap (+8 more)
...
Cohesion: 0.07
Nodes (27): autoincrement, name, notNull, primaryKey, type, backed_up, counter, public_key (+19 more)
...
Cohesion: 0.12
Nodes (14): #each(), introducedCount, other, stateIcon(), $lib/content/did-you-know, $lib/content/recipes, $lib/server/guidance/allergen-status, $lib/utils/suggest (+6 more)

### Community 46 - "Community 46"
Cohesion: 0.12
Nodes (19): categoryLabel(), computeReminders(), push(), Reminder, ReminderInput, Severity, SEVERITY_RANK, ALL_ALLERGENS (+11 more)
...
Cohesion: 0.2
Nodes (14): getAllStagesForBento(), getStageForAgeMonths(), getRecipesForStage(), getSeasonalNames(), SEASONAL_FOODS_BY_MONTH, loadAllergenStatus(), load(), loadSeasonalFoods() (+6 more)
...
Cohesion: 0.29
Nodes (7): autoincrement, name, notNull, primaryKey, type, allergen_type, columns
...
- **Why does `languageTag()` connect `Community 55` to `i18n Messages (auth.*)`, `i18n Messages (chrome.*)`, `Offline Log Queue (IndexedDB)`, `UI Primitives & LEAP/EAT Cards`?**
  _High betweenness centrality (0.080) - this node is a cross-community bridge._
- **Why does `handleOnline()` connect `Community 35` to `Community 69`?**
