...
## Corpus Check
- 414 files · ~607,112 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2234 nodes · 4340 edges · 157 communities (147 shown, 10 thin omitted)
...
Cohesion: 0.01
Nodes (292): addSymptomLabel(), addSymptomNote(), addSymptomNotePlaceholder(), addSymptomSubmit(), allergenDialogBadgeFromMonths(), allergenDialogClose(), allergenDialogHowToOfferTitle(), allergenDialogSevereSignsTitle() (+284 more)

### Community 1 - "i18n Messages (chrome.*)"
Cohesion: 0.01
Nodes (230): addSymptomNotePlaceholder(), addSymptomObservedAt(), allergenDialogFirstSignsTitle(), allergenDialogHowToOfferTitle(), allergenDialogSevereSignsTitle(), allergenDialogSeverityMajor(), allergenDialogSourcesTitle(), allergenDialogTitle() (+222 more)

### Community 2 - "i18n Messages (errors+log+landing)"
Cohesion: 0.01
Nodes (159): addSymptomNote(), addSymptomSubmit(), allergenDialogClose(), allergenDialogHowToOfferTitle(), allergenDialogTitle(), allergenDialogWhyEarlyTitle(), aujourdhuiAllergensFading(), aujourdhuiAllergensOk() (+151 more)

### Community 3 - "Page Loaders & Form Actions"
Cohesion: 0.01
Nodes (158): addSymptomLabel(), addSymptomNote(), addSymptomSubmit(), addSymptomTitle(), allergenDialogBadgeFromMonths(), allergenDialogClose(), allergenDialogWhyEarlyTitle(), aujourdhuiAllergensOk() (+150 more)

### Community 4 - "Test Fixtures & Setup Helpers"
Cohesion: 0.01
Nodes (229): addSymptomLabel(), addSymptomNotePlaceholder(), addSymptomObservedAt(), addSymptomTitle(), allergenDialogBadgeFromMonths(), allergenDialogFirstSignsTitle(), allergenDialogSevereSignsTitle(), allergenDialogSeverityMajor() (+221 more)

### Community 5 - "Branding, App Shell & PWA Manifest"
Cohesion: 0.01
Nodes (97): addSymptomObservedAt(), addSymptomTitle(), allergenDialogFirstSignsTitle(), allergenDialogTitle(), aujourdhuiAllergensTodo(), authAccountDataDescription(), authAccountDataExport(), authAccountDeleteSubmitting() (+89 more)
...
Cohesion: 0.1
Nodes (21): load(), load(), load(), load(), LogActionAbort, load(), load(), load() (+13 more)
...
Cohesion: 0.14
Nodes (17): load(), loadBentoAllergens(), loadWeeklyEntries(), dismissReminder(), loadAnalyticsBuckets(), loadCoparentActivity(), loadDismissals(), loadDiversityMetrics() (+9 more)
...
- **Why does `isValidBirthDate()` connect `Auth Routes & i18n Routing` to `DB Init, Backup & Seed`?**
