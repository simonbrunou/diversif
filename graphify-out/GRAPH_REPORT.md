# Graph Report - agent-ae3198a27b4ca0266  (2026-06-11)

## Corpus Check
- 460 files · ~389,341 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4584 nodes · 8603 edges · 161 communities (148 shown, 13 thin omitted)
- Extraction: 91% EXTRACTED · 9% INFERRED · 0% AMBIGUOUS · INFERRED: 803 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `3ef06084`
...
Cohesion: 0.01
Nodes (603): addSymptomLabel(), addSymptomNote(), addSymptomNotePlaceholder(), addSymptomObservedAt(), addSymptomSeveritySevereSrPrefix(), addSymptomSubmit(), addSymptomTitle(), aideNavLabel() (+595 more)

### Community 1 - "i18n Messages (chrome.*)"
Cohesion: 0.01
Nodes (171): addSymptomLabel(), addSymptomSeveritySevereSrPrefix(), addSymptomSubmit(), addSymptomTitle(), allergenDialogBadgeFromMonths(), allergenDialogHowToOfferTitle(), allergenDialogWhyEarlyTitle(), aujourdhuiAllergensOk() (+163 more)

### Community 2 - "i18n Messages (errors+log+landing)"
Cohesion: 0.01
Nodes (325): addSymptomObservedAt(), addSymptomSubmit(), allergenDialogFirstSignsTitle(), allergenDialogHowToOfferTitle(), allergenDialogSeverityMajor(), allergenDialogWhyEarlyTitle(), allergenPassportFadingHint, allergenPassportSectionOther (+317 more)

### Community 3 - "Page Loaders & Form Actions"
Cohesion: 0.01
Nodes (324): addSymptomNote(), addSymptomNotePlaceholder(), addSymptomObservedAt(), allergenDialogClose(), allergenDialogFirstSignsTitle(), allergenDialogSevereSignsTitle(), allergenDialogSeverityMajor(), allergenDialogSourcesTitle() (+316 more)

### Community 4 - "Test Fixtures & Setup Helpers"
Cohesion: 0.01
Nodes (170): addSymptomLabel(), addSymptomNote(), addSymptomNotePlaceholder(), addSymptomSeveritySevereSrPrefix(), addSymptomTitle(), allergenDialogBadgeFromMonths(), allergenDialogClose(), allergenDialogSevereSignsTitle() (+162 more)

### Community 5 - "Branding, App Shell & PWA Manifest"
Cohesion: 0.09
Nodes (43): load(), foodEntries, foods, symptoms, makeDeleteEvent(), makeFormEvent(), setup(), loadFor() (+35 more)

### Community 6 - "Architecture Patterns & Conventions"
Cohesion: 0.07
Nodes (53): load(), VALID_THEMES, db, actions, load(), schema, load(), load() (+45 more)

### Community 7 - "Auth Routes & i18n Routing"
Cohesion: 0.05
Nodes (54): ALLERGEN_GUIDANCE, AllergenGuidance, APPROACHES, BentoStage, CATEGORY_GUIDANCE, CategoryGuidance, CHOKING_HAZARDS, ChokingHazard (+46 more)
...
Cohesion: 0.06
Nodes (41): Child, children, Food, FoodEntry, IdempotencyKey, Invitation, memberships, NewChild (+33 more)

### Community 10 - "Offline Log Queue (IndexedDB)"
Cohesion: 0.06
Nodes (6): foods, user, $lib/utils/monitor-timer, page, setPagePathname(), textSnippet()

### Community 11 - "User Memory & Medical Audit"
Cohesion: 0.09
Nodes (44): Passkey, PASSKEY_AUTOFILL_OPTIONS_LIMIT, PASSKEY_OPTIONS_LIMIT, POST(), createSession(), AuthenticationResult, base64UrlToBuffer(), bufferToBase64Url() (+36 more)

### Community 12 - "SEO / JSON-LD Library"
Cohesion: 0.06
Nodes (10): authenticateWithPasskey(), signInWithPasskey(), filtered, baseClass, i18n, $lib/utils/cn, $lib/utils/textures, reroute (+2 more)
...
Cohesion: 0.09
Nodes (28): seed(), seed(), seed(), seedTestUser(), auditSpy, seed(), auditSpy, seed() (+20 more)
...
Cohesion: 0.1
Nodes (30): SEVERE, Severity, severityOf(), SYMPTOM_LABELS, SymptomLabel, WARN, countNthExposition(), deleteSymptomById() (+22 more)
...
Cohesion: 0.13
Nodes (21): getAllStagesForBento(), getStageForAgeMonths(), Stage, loadAllergenStatus(), load(), load(), AllergenReportRow, load() (+13 more)

### Community 26 - "Idempotency Primitive"
Cohesion: 0.06
Nodes (31): food_id, given_at, logged_by, reaction, texture, columns, autoincrement, name (+23 more)
...
Cohesion: 0.08
Nodes (4): streakLabel, $lib/server/guidance/reminders, $lib/types, $lib/utils/texture-labels
...
Cohesion: 0.11
Nodes (17): hasUniqueShape(), isUniqueViolation(), idempotencyKeys, webauthnChallenges, makeAutofillEvent(), makeModalEvent(), CleanupResult, runCleanup() (+9 more)
...
Cohesion: 0.13
Nodes (14): actions, ActiveInvite, checkJoinInviteLookupLimit(), findActiveInvitation(), load(), userHasMembership(), invitations, isE2E() (+6 more)

### Community 35 - "Community 35"
Cohesion: 0.08
Nodes (26): autoincrement, name, notNull, primaryKey, type, backed_up, last_used_at, public_key (+18 more)
...
Cohesion: 0.18
Nodes (18): execRows(), Executor, actions, AllergenSummary, load(), dismissReminder(), loadDismissals(), ttlForReminderKey() (+10 more)
...
Cohesion: 0.13
Nodes (18): Session, User, ARGON_OPTS, findUserByEmail(), getDecoyHash(), hashSessionToken(), invalidateSession(), listMembershipsForUser() (+10 more)
...
Cohesion: 0.1
Nodes (7): baseProps, dayjs/locale/fr, $lib/content/symptoms, $lib/utils/age, $lib/utils/categories, $lib/utils/reactions, $lib/utils/search

### Community 44 - "Community 44"
Cohesion: 0.09
Nodes (22): food_entries_texture_check, checkConstraints, columns, isUnique, name, compositePrimaryKeys, foreignKeys, indexes (+14 more)

### Community 45 - "Community 45"
Cohesion: 0.16
Nodes (9): filterIncomingBreadcrumb(), ScrubbableEvent, scrubEvent(), scrubPathname(), scrubUrlString(), enforceLanguageTag(), setLanguageTag(), handleError() (+1 more)
...
Cohesion: 0.18
Nodes (14): load(), loadBentoAllergens(), loadWeeklyEntries(), loadRepeatCandidates(), formatDateInputValue(), formatDateTime(), formatMonthsSince(), formatRelative() (+6 more)
...
Cohesion: 0.17
Nodes (14): Executor, ResolveFoodInput, ResolveFoodResult, #each(), CATEGORY_IDS, CATEGORY_LABEL_RESOLVERS, CategoryClasses, CategoryColor (+6 more)
...
Cohesion: 0.19
Nodes (9): Membership, ChildSummary, RecentEntry, SafeUser, SymptomEntry, load(), parseChildIdParamOrNull(), fakeUser (+1 more)

### Community 68 - "Community 68"
Cohesion: 0.16
Nodes (9): actions, load(), profileSchema, fail(), parseForm(), ParseFormResult, parseFormWithKey(), ParseFormWithKeyResult (+1 more)
...
Cohesion: 0.15
Nodes (9): args, elapsedSec, failedFiles, files, isNonExecutable(), passthroughFlags, paths, phantom() (+1 more)
...
Cohesion: 0.25
Nodes (8): columnsFrom, columnsTo, name, onDelete, onUpdate, tableFrom, tableTo, foods_custom_for_child_id_children_id_fk
...
Cohesion: 0.29
Nodes (7): custom_for_child_id, autoincrement, name, notNull, primaryKey, type, columns
...
Cohesion: 0.4
Nodes (3): $lib/server/guidance/allergen-status, $lib/utils/suggest, SuggestFood
...
Cohesion: 0.33
Nodes (6): checkConstraints, compositePrimaryKeys, foreignKeys, name, uniqueConstraints, foods
...
- **Why does `languageTag()` connect `i18n Messages (auth.*)` to `Community 45`, `Community 52`, `SEO / JSON-LD Library`?**
  _High betweenness centrality (0.082) - this node is a cross-community bridge._
- **Why does `localizedHref()` connect `SEO / JSON-LD Library` to `i18n Messages (auth.*)`, `Legal Pages`?**
  _High betweenness centrality (0.017) - this node is a cross-community bridge._
- **Why does `$lib/paraglide/messages.js` connect `Reaction Reports & Reminders` to `Community 32`, `Community 65`, `SEO / JSON-LD Library`, `Community 116`, `Community 52`, `Community 118`?**
  _High betweenness centrality (0.012) - this node is a cross-community bridge._
- **Are the 605 inferred relationships involving `languageTag()` (e.g. with `formatRelative()` and `formatMonthsSince()`) actually correct?**
  _`languageTag()` has 605 INFERRED edges - model-reasoned connections that need verification._
