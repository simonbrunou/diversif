<<<<<<< HEAD
# Graph Report - agent-aef7fbca8239da4cc  (2026-06-11)

## Corpus Check
- 450 files · ~375,191 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4493 nodes · 8460 edges · 153 communities (140 shown, 13 thin omitted)
- Extraction: 91% EXTRACTED · 9% INFERRED · 0% AMBIGUOUS · INFERRED: 782 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `9b81ff7a`
=======
# Graph Report - agent-ab3aed60d5b6021c1  (2026-06-11)

## Corpus Check
- 453 files · ~369,401 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4289 nodes · 8208 edges · 154 communities (141 shown, 13 thin omitted)
- Extraction: 91% EXTRACTED · 9% INFERRED · 0% AMBIGUOUS · INFERRED: 713 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `dbdb442d`
>>>>>>> origin/main
...
1. `languageTag()` - 596 edges
=======
- [[_COMMUNITY_Community 141|Community 141]]

## God Nodes (most connected - your core abstractions)
1. `languageTag()` - 526 edges
>>>>>>> origin/main
2. `testDb` - 60 edges
3. `makeRouteEvent()` - 52 edges
4. `resetTestDb()` - 50 edges
5. `users` - 46 edges
6. `requireUser()` - 45 edges
7. `devDependencies` - 42 edges
8. `safeUser()` - 39 edges
9. `db` - 39 edges
10. `Tasks` - 38 edges
...
- `parseFormWithKey()` --calls--> `fail()`  [INFERRED]
  src/lib/server/forms.ts → scripts/verify-backup-restore.ts
<<<<<<< HEAD
- `requireFreshAuth()` --calls--> `fail()`  [INFERRED]
  src/lib/server/fresh-auth.ts → scripts/verify-backup-restore.ts
...
Cohesion: 0.01
Nodes (589): addSymptomLabel(), addSymptomNote(), addSymptomNotePlaceholder(), addSymptomObservedAt(), addSymptomSeveritySevereSrPrefix(), addSymptomSubmit(), addSymptomTitle(), aideNavLabel() (+581 more)

### Community 1 - "i18n Messages (chrome.*)"
Cohesion: 0.01
Nodes (178): addSymptomSeveritySevereSrPrefix(), addSymptomSubmit(), allergenDialogBadgeFromMonths(), allergenDialogSevereSignsTitle(), allergenDialogSourcesTitle(), allergenDialogTitle(), aujourdhuiBilanAliments(), aujourdhuiBilanAlimentsDelta() (+170 more)

### Community 2 - "i18n Messages (errors+log+landing)"
Cohesion: 0.01
Nodes (178): addSymptomLabel(), addSymptomNote(), addSymptomNotePlaceholder(), addSymptomSeveritySevereSrPrefix(), addSymptomSubmit(), allergenDialogHowToOfferTitle(), allergenDialogSevereSignsTitle(), allergenDialogSeverityMajor() (+170 more)

### Community 3 - "Page Loaders & Form Actions"
Cohesion: 0.01
Nodes (317): addSymptomLabel(), addSymptomNote(), addSymptomNotePlaceholder(), addSymptomObservedAt(), addSymptomTitle(), allergenDialogClose(), allergenDialogFirstSignsTitle(), allergenDialogHowToOfferTitle() (+309 more)

### Community 4 - "Test Fixtures & Setup Helpers"
Cohesion: 0.01
Nodes (317): addSymptomObservedAt(), addSymptomTitle(), allergenDialogBadgeFromMonths(), allergenDialogClose(), allergenDialogFirstSignsTitle(), allergenDialogSourcesTitle(), allergenDialogWhyEarlyTitle(), allergenPassportFadingHint (+309 more)

### Community 5 - "Branding, App Shell & PWA Manifest"
Cohesion: 0.08
Nodes (53): load(), foodEntries, foods, makeDeleteEvent(), makeFormEvent(), setup(), exportSpy, loadFor() (+45 more)

### Community 6 - "Architecture Patterns & Conventions"
Cohesion: 0.05
Nodes (66): getAllStagesForBento(), getStageForAgeMonths(), execRows(), Executor, db, drizzleDb, pool, sqlite (+58 more)

### Community 7 - "Auth Routes & i18n Routing"
Cohesion: 0.05
Nodes (58): seed(), actions, load(), seed(), seed(), actions, load(), LOGIN_LIMIT (+50 more)
...
Cohesion: 0.06
Nodes (52): Child, children, Food, FoodEntry, IdempotencyKey, Invitation, invitations, Membership (+44 more)

### Community 10 - "Offline Log Queue (IndexedDB)"
Cohesion: 0.06
Nodes (5): foods, user, page, setPagePathname(), textSnippet()

### Community 11 - "User Memory & Medical Audit"
Cohesion: 0.07
Nodes (43): Stage, SEVERE, Severity, severityOf(), SYMPTOM_LABELS, SymptomLabel, WARN, symptoms (+35 more)
...
Cohesion: 0.12
Nodes (8): $lib/i18n, $lib/paraglide/messages, $lib/seo, $lib/utils/localized-href, $lib/utils/milestones, $app/state, Icon, string

### Community 15 - "DB Init, Backup & Seed"
Cohesion: 0.14
Nodes (8): @simplewebauthn/browser, svelte/elements, $app/environment, $app/forms, $app/navigation, $lib/forms/tracked-enhance, $lib/offline/uuid, $lib/utils/dates
...
Cohesion: 0.05
Nodes (37): food_id, given_at, logged_by, notes, reaction, texture, columns, autoincrement (+29 more)
...
Cohesion: 0.06
Nodes (32): autoincrement, name, notNull, primaryKey, type, backed_up, counter, device_type (+24 more)
...
Cohesion: 0.11
Nodes (14): filterIncomingBreadcrumb(), ScrubbableEvent, scrubEvent(), scrubPathname(), scrubUrlString(), enforceLanguageTag(), setLanguageTag(), listMembershipsForUser() (+6 more)
...
Cohesion: 0.07
Nodes (30): food_entries_texture_check, checkConstraints, columnsFrom, columnsTo, name, onDelete, onUpdate, tableFrom (+22 more)
...
Cohesion: 0.11
Nodes (25): ALLERGEN_GUIDANCE, AllergenGuidance, APPROACHES, BentoStage, CATEGORY_GUIDANCE, CategoryGuidance, CHOKING_HAZARDS, ChokingHazard (+17 more)

### Community 30 - "Reminders Engine"
Cohesion: 0.11
Nodes (9): filtered, baseClass, $lib/utils/age, $lib/utils/categories, $lib/utils/cn, $lib/utils/reactions, $lib/utils/search, $lib/utils/texture-labels (+1 more)
...
Cohesion: 0.1
Nodes (4): i18n, reroute, cn(), localizedHref()
...
Cohesion: 0.1
Nodes (15): ActionError, ActionFailure, ActionRedirect, ActionResult, clear(), deleteRow(), emit(), enqueue() (+7 more)
...
Cohesion: 0.14
Nodes (18): idempotencyKeys, webauthnChallenges, CleanupResult, runCleanup(), startCleanupTimer(), stopCleanupTimer(), IdempotencyInFlight, IdempotencyScopeMismatch (+10 more)
...
### Community 0 - "i18n Messages (auth.*)"
Cohesion: 0.01
Nodes (519): addSymptomLabel(), addSymptomNote(), addSymptomNotePlaceholder(), addSymptomObservedAt(), addSymptomSeveritySevereSrPrefix(), addSymptomSubmit(), addSymptomTitle(), aideNavLabel() (+511 more)

### Community 1 - "i18n Messages (chrome.*)"
Cohesion: 0.01
Nodes (213): addSymptomLabel(), addSymptomNote(), addSymptomNotePlaceholder(), addSymptomSubmit(), addSymptomTitle(), allergenDialogFirstSignsTitle(), allergenDialogSevereSignsTitle(), allergenDialogSeverityMajor() (+205 more)

### Community 2 - "i18n Messages (errors+log+landing)"
Cohesion: 0.01
Nodes (213): addSymptomNotePlaceholder(), addSymptomObservedAt(), addSymptomSubmit(), addSymptomTitle(), allergenDialogClose(), allergenDialogHowToOfferTitle(), allergenDialogSourcesTitle(), allergenDialogWhyEarlyTitle() (+205 more)

### Community 3 - "Page Loaders & Form Actions"
Cohesion: 0.01
Nodes (282): addSymptomObservedAt(), addSymptomSeveritySevereSrPrefix(), allergenDialogBadgeFromMonths(), allergenDialogClose(), allergenDialogHowToOfferTitle(), allergenDialogSourcesTitle(), allergenDialogTitle(), allergenPassportFadingHint (+274 more)

### Community 4 - "Test Fixtures & Setup Helpers"
Cohesion: 0.01
Nodes (282): addSymptomLabel(), addSymptomNote(), addSymptomSeveritySevereSrPrefix(), allergenDialogBadgeFromMonths(), allergenDialogFirstSignsTitle(), allergenDialogSevereSignsTitle(), allergenDialogSeverityMajor(), allergenDialogTitle() (+274 more)

### Community 5 - "Branding, App Shell & PWA Manifest"
Cohesion: 0.09
Nodes (48): load(), foodEntries, foods, symptoms, makeDeleteEvent(), makeFormEvent(), setup(), loadFor() (+40 more)

### Community 6 - "Architecture Patterns & Conventions"
Cohesion: 0.06
Nodes (42): seed(), actions, load(), seed(), seed(), seedTestUser(), seed(), actions (+34 more)

### Community 7 - "Auth Routes & i18n Routing"
Cohesion: 0.08
Nodes (46): PASSKEY_AUTOFILL_OPTIONS_LIMIT, PASSKEY_OPTIONS_LIMIT, POST(), requireFreshAuth(), AuthenticationResult, base64UrlToBuffer(), bufferToBase64Url(), buildAuthenticationOptions() (+38 more)

### Community 8 - "UI Components & Tests"
Cohesion: 0.09
Nodes (38): load(), VALID_THEMES, db, loadEntry(), parseEntryId(), schema, load(), load() (+30 more)

### Community 9 - "WebAuthn / Passkeys"
Cohesion: 0.07
Nodes (40): Child, children, Food, FoodEntry, IdempotencyKey, Invitation, memberships, NewChild (+32 more)
...
### Community 11 - "User Memory & Medical Audit"
Cohesion: 0.08
Nodes (40): FORBIDDEN_FOODS, execRows(), Executor, categoryLabel(), computeReminders(), push(), Reminder, ReminderInput (+32 more)

### Community 12 - "SEO / JSON-LD Library"
Cohesion: 0.12
Nodes (7): $lib/i18n, $lib/paraglide/messages, $lib/seo, $lib/utils/localized-href, $app/state, Icon, string

### Community 13 - "UI Component Library"
Cohesion: 0.08
Nodes (28): hasUniqueShape(), isUniqueViolation(), actions, load(), LOGIN_LIMIT, schema, fail(), parseForm() (+20 more)
...
### Community 16 - "Allergens & Milestones"
Cohesion: 0.12
Nodes (8): @simplewebauthn/browser, svelte/elements, $app/environment, $app/forms, $app/navigation, $lib/forms/tracked-enhance, $lib/offline/uuid, $lib/utils/milestones

### Community 17 - "Sentry Observability"
Cohesion: 0.07
Nodes (9): filtered, baseClass, $lib/paraglide/runtime, $lib/utils/age, $lib/utils/categories, $lib/utils/reactions, $lib/utils/search, $lib/utils/texture-labels (+1 more)
...
### Community 23 - "Migration Tests"
Cohesion: 0.17
Nodes (5): sources, $lib/content/guidance, $lib/content/sources, $lib/utils/allergens, logHref()
...
### Community 26 - "Idempotency Primitive"
Cohesion: 0.09
Nodes (17): purgeBeforeSubmit(), purgeClientState(), ActionError, ActionFailure, ActionRedirect, ActionResult, clear(), deleteRow() (+9 more)
...
### Community 28 - "Reactions Vocabulary"
Cohesion: 0.14
Nodes (25): SEVERE, Severity, severityOf(), SYMPTOM_LABELS, SymptomLabel, WARN, countNthExposition(), deleteSymptomById() (+17 more)
...
### Community 30 - "Reminders Engine"
Cohesion: 0.07
Nodes (30): food_entries_texture_check, checkConstraints, columns, isUnique, name, compositePrimaryKeys, columnsFrom, columnsTo (+22 more)
...
### Community 33 - "Community 33"
Cohesion: 0.14
Nodes (20): getAllStagesForBento(), getStageForAgeMonths(), Stage, loadAllergenStatus(), load(), AllergenReportRow, load(), ReportEntry (+12 more)
...
### Community 37 - "Community 37"
Cohesion: 0.15
Nodes (19): absoluteUrl(), articleJsonLd(), BreadcrumbItem, breadcrumbJsonLd(), faqPageJsonLd(), organizationJsonLd(), resolveOrigin(), SeoInput (+11 more)
...
>>>>>>> origin/main
Cohesion: 0.09
Nodes (4): baseProps, $lib/content/symptoms, $lib/types, $lib/utils/monitor-timer
...
### Community 42 - "Community 42"
Cohesion: 0.08
Nodes (25): key, redirect, scope, user_id, columns, autoincrement, name, notNull (+17 more)
...
=======
Cohesion: 0.15
Nodes (14): idempotencyKeys, sessions, webauthnChallenges, CleanupResult, runCleanup(), startCleanupTimer(), stopCleanupTimer(), IdempotencyInFlight (+6 more)

### Community 46 - "Community 46"
Cohesion: 0.1
Nodes (6): streakLabel, $lib/server/guidance/allergen-status, $lib/server/guidance/reminders, $lib/utils/dates, $lib/utils/suggest, SuggestFood
...
### Community 46 - "Community 46"
Cohesion: 0.09
Nodes (8): ../app.css, $lib/offline/queue, $lib/paraglide/runtime, $lib/utils/theme, bentoKids, firstChildId, isAccountRoute, locale
...
### Community 53 - "Community 53"
Cohesion: 0.11
Nodes (13): drizzleDb, pool, sqlite, AnyDb, applySeedCorrections(), FOODS_SEED, SeedFood, seedFoods() (+5 more)

### Community 54 - "Community 54"
Cohesion: 0.17
Nodes (12): actions, ActiveInvite, checkJoinInviteLookupLimit(), findActiveInvitation(), load(), userHasMembership(), invitations, generateInviteCodeRawSpy (+4 more)
...
Cohesion: 0.18
Nodes (13): categoryLabel(), computeReminders(), push(), Reminder, Severity, SEVERITY_RANK, findRepeatCandidates(), FindRepeatCandidatesOptions (+5 more)

### Community 63 - "Community 63"
Cohesion: 0.22
Nodes (11): actions, ActiveInvite, checkJoinInviteLookupLimit(), findActiveInvitation(), load(), userHasMembership(), hasUniqueShape(), isUniqueViolation() (+3 more)
...
Cohesion: 0.14
Nodes (5): streakLabel, $lib/server/guidance/allergen-status, $lib/server/guidance/reminders, $lib/utils/suggest, SuggestFood
...
Cohesion: 0.19
Nodes (7): filterIncomingBreadcrumb(), ScrubbableEvent, scrubEvent(), scrubPathname(), scrubUrlString(), enforceLanguageTag(), setLanguageTag()
>>>>>>> origin/main
...
Cohesion: 0.17
Nodes (13): Executor, ResolveFoodInput, ResolveFoodResult, resolveOrInsertFood(), CATEGORY_IDS, CATEGORY_LABEL_RESOLVERS, CategoryClasses, CategoryColor (+5 more)
>>>>>>> origin/main
...
Cohesion: 0.22
Nodes (8): load(), load(), getLegalIdentity(), isPlaceholder(), LegalIdentity, read(), KEYS, original
...
### Community 78 - "Community 78"
Cohesion: 0.21
Nodes (8): logHref(), ALLERGENS, getAllergenLabel(), PriorityIntroductionAllergenId, CATEGORY_THRESHOLDS, celebrate(), MilestoneKind, pickMilestoneFromQuery()
...
Cohesion: 0.24
Nodes (10): #each(), CATEGORY_IDS, CATEGORY_LABEL_RESOLVERS, CategoryClasses, CategoryColor, CLASS_MAP, getCategoryClasses(), getCategoryColor() (+2 more)
=======
### Community 81 - "Community 81"
Cohesion: 0.23
Nodes (8): load(), loadBentoAllergens(), loadWeeklyEntries(), AllergenItem, PRIORITY_SET, loadRepeatCandidates(), fuzzyMatch(), normalize()
...
### Community 84 - "Community 84"
Cohesion: 0.23
Nodes (7): ALLERGENS, getAllergenLabel(), PriorityIntroductionAllergenId, CATEGORY_THRESHOLDS, celebrate(), MilestoneKind, pickMilestoneFromQuery()
...
Cohesion: 0.17
Nodes (7): ../app.css, $lib/offline/queue, $lib/utils/theme, bentoKids, firstChildId, isAccountRoute, locale

### Community 91 - "Community 91"
Cohesion: 0.26
Nodes (6): Membership, RecentEntry, SafeUser, SymptomEntry, fakeUser, Locals
...
Cohesion: 0.24
Nodes (6): actions, deleteSchema, load(), renameSchema, auditSpy, AuditEvent
...
### Community 91 - "Community 91"
Cohesion: 0.27
Nodes (6): resolveMessageKey(), trackSubmission(), $lib/paraglide/messages.js, getTextureLabel(), LABEL_FNS, TEXTURE_VALUES
=======
...
### Community 101 - "Community 101"
Cohesion: 0.32
Nodes (7): ReminderInput, ALL_ALLERGENS, allergenEntry(), entry(), input(), isolated(), NOW

### Community 102 - "Community 102"
Cohesion: 0.25
Nodes (8): columnsFrom, columnsTo, name, onDelete, onUpdate, tableFrom, tableTo, food_entries_food_id_foods_id_fk
...
Cohesion: 0.25
Nodes (8): columnsFrom, columnsTo, name, onDelete, onUpdate, tableFrom, tableTo, food_entries_child_id_children_id_fk
...
## Knowledge Gaps
- **1418 isolated node(s):** `name`, `version`, `private`, `type`, `_bun_invocation_note` (+1413 more)
...
<<<<<<< HEAD
- **Why does `languageTag()` connect `i18n Messages (auth.*)` to `Community 32`, `Food Categories`, `User Memory & Medical Audit`?**
  _High betweenness centrality (0.084) - this node is a cross-community bridge._
- **Why does `localizedHref()` connect `Community 32` to `i18n Messages (auth.*)`, `DB Init, Backup & Seed`?**
  _High betweenness centrality (0.015) - this node is a cross-community bridge._
- **Why does `dependencies` connect `Community 52` to `Community 92`?**
  _High betweenness centrality (0.007) - this node is a cross-community bridge._
- **Are the 591 inferred relationships involving `languageTag()` (e.g. with `formatRelative()` and `formatMonthsSince()`) actually correct?**
  _`languageTag()` has 591 INFERRED edges - model-reasoned connections that need verification._
=======
- **Why does `languageTag()` connect `i18n Messages (auth.*)` to `Community 96`, `Community 67`, `Community 47`?**
  _High betweenness centrality (0.083) - this node is a cross-community bridge._
- **Why does `localizedHref()` connect `Community 47` to `i18n Messages (auth.*)`, `SEO / JSON-LD Library`?**
  _High betweenness centrality (0.016) - this node is a cross-community bridge._
- **Why does `handleOnline()` connect `Idempotency Primitive` to `Community 90`?**
  _High betweenness centrality (0.007) - this node is a cross-community bridge._
- **Are the 521 inferred relationships involving `languageTag()` (e.g. with `formatRelative()` and `formatMonthsSince()`) actually correct?**
  _`languageTag()` has 521 INFERRED edges - model-reasoned connections that need verification._
>>>>>>> origin/main
