...
## Corpus Check
- 459 files · ~418,250 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4440 nodes · 9015 edges · 161 communities (145 shown, 16 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 193 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `2ddb7413`
...
Cohesion: 0.01
Nodes (118): addSymptomNote(), addSymptomSubmit(), allergenDialogSeverityMajor(), aujourdhuiAllergensTitle(), aujourdhuiAllergensTodo(), aujourdhuiBilanStreak(), aujourdhuiBilanStreakDaysOne(), aujourdhuiBilanStreakDaysOther() (+110 more)

### Community 1 - "i18n Messages (chrome.*)"
Cohesion: 0.01
Nodes (240): addSymptomLabel(), addSymptomNotePlaceholder(), addSymptomObservedAt(), addSymptomTitle(), allergenDialogBadgeFromMonths(), allergenDialogClose(), allergenDialogFirstSignsTitle(), allergenDialogHowToOfferTitle() (+232 more)

### Community 2 - "i18n Messages (errors+log+landing)"
Cohesion: 0.01
Nodes (174): addSymptomLabel(), addSymptomNote(), addSymptomNotePlaceholder(), allergenDialogClose(), allergenDialogFirstSignsTitle(), allergenDialogSeverityMajor(), allergenDialogSourcesTitle(), aujourdhuiAllergensFading() (+166 more)

### Community 3 - "Page Loaders & Form Actions"
Cohesion: 0.01
Nodes (174): addSymptomNote(), addSymptomObservedAt(), addSymptomTitle(), allergenDialogClose(), allergenDialogFirstSignsTitle(), allergenDialogSeverityMajor(), allergenDialogSourcesTitle(), allergenDialogTitle() (+166 more)

### Community 4 - "Test Fixtures & Setup Helpers"
Cohesion: 0.01
Nodes (135): addSymptomNotePlaceholder(), addSymptomSubmit(), allergenDialogHowToOfferTitle(), allergenDialogSevereSignsTitle(), aujourdhuiAllergensOk(), aujourdhuiAllergensTodo(), aujourdhuiBilanStreakDaysOther(), aujourdhuiRecentEmpty() (+127 more)

### Community 5 - "Branding, App Shell & PWA Manifest"
Cohesion: 0.01
Nodes (132): allergenDialogHowToOfferTitle(), allergenDialogWhyEarlyTitle(), aujourdhuiAllergensTitle(), aujourdhuiRecentEmpty(), authAccountAppearanceSection(), authAccountCurrentPasswordLabel(), authAccountDisplayNameLabel(), authAccountLogoutEverywhere() (+124 more)

### Community 6 - "Architecture Patterns & Conventions"
Cohesion: 0.01
Nodes (194): addSymptomObservedAt(), addSymptomSeveritySevereSrPrefix(), addSymptomSubmit(), addSymptomTitle(), allergenDialogBadgeFromMonths(), allergenDialogSevereSignsTitle(), allergenDialogTitle(), allergenPassportFadingHint (+186 more)

### Community 7 - "Auth Routes & i18n Routing"
Cohesion: 0.01
Nodes (191): addSymptomLabel(), addSymptomSeveritySevereSrPrefix(), allergenDialogBadgeFromMonths(), allergenPassportFadingHint, allergenPassportSectionOther, allergenPassportSectionPriority, allergenPassportStateCleared, allergenPassportStateFading (+183 more)
...
Cohesion: 0.06
Nodes (55): db, drizzleDb, pool, sqlite, actions, load(), loadEntry(), schema (+47 more)

### Community 10 - "Offline Log Queue (IndexedDB)"
Cohesion: 0.04
Nodes (8): FRUITS, baseProps, foods, user, ./DiscoverGroup.svelte, page, setPagePathname(), textSnippet()

### Community 11 - "User Memory & Medical Audit"
Cohesion: 0.07
Nodes (54): PASSKEY_AUTOFILL_OPTIONS_LIMIT, PASSKEY_OPTIONS_LIMIT, POST(), audit(), requireFreshAuth(), AuthenticationResult, base64UrlToBuffer(), bufferToBase64Url() (+46 more)

### Community 12 - "SEO / JSON-LD Library"
Cohesion: 0.06
Nodes (55): VALID_THEMES, Child, children, Food, FoodEntry, IdempotencyKey, idempotencyKeys, Invitation (+47 more)

### Community 13 - "UI Component Library"
Cohesion: 0.06
Nodes (44): seed(), seed(), seed(), actions, LOGIN_LIMIT, schema, seedTestUser(), POST() (+36 more)

### Community 14 - "Account Export / Delete"
Cohesion: 0.06
Nodes (45): SEVERE, Severity, severityOf(), SYMPTOM_LABELS, SymptomLabel, WARN, countNthExposition(), deleteSymptomById() (+37 more)

### Community 15 - "DB Init, Backup & Seed"
Cohesion: 0.1
Nodes (16): $lib/content/did-you-know, $lib/content/recipes, $lib/i18n, $lib/paraglide/messages, $lib/seo, $lib/utils/localized-href, $lib/utils/milestones, $lib/utils/suggest (+8 more)
...
Cohesion: 0.06
Nodes (10): filtered, baseClass, $lib/paraglide/messages.js, $lib/paraglide/runtime, $lib/utils/age, $lib/utils/categories, $lib/utils/reactions, $lib/utils/search (+2 more)

### Community 19 - "Invitations & Memberships"
Cohesion: 0.15
Nodes (12): @simplewebauthn/browser, svelte/elements, $app/environment, $app/forms, $app/navigation, $lib/forms/tracked-enhance, $lib/offline/uuid, $lib/utils/cn (+4 more)
...
Cohesion: 0.09
Nodes (29): SAMPLE, FACT_CARDS, FactCard, ALLERGEN_GUIDANCE, AllergenGuidance, APPROACHES, BentoStage, CATEGORY_GUIDANCE (+21 more)
...
Cohesion: 0.08
Nodes (21): load(), actions, deleteSchema, load(), renameSchema, auditSpy, seed(), actions (+13 more)
...
Cohesion: 0.11
Nodes (21): Membership, User, RecentEntry, SafeUser, SymptomEntry, AllergenReportRow, load(), ReportEntry (+13 more)
...
Cohesion: 0.12
Nodes (22): categoryLabel(), computeReminders(), push(), Reminder, ReminderInput, Severity, SEVERITY_RANK, ALL_ALLERGENS (+14 more)
...
Cohesion: 0.1
Nodes (3): $lib/content/symptoms, $lib/types, $lib/utils/monitor-timer
...
- **Why does `languageTag()` connect `Account Export / Delete` to `i18n Messages (auth.*)`, `i18n Messages (chrome.*)`, `Community 45`?**
  _High betweenness centrality (0.081) - this node is a cross-community bridge._
- **Why does `devDependencies` connect `Sentry Observability` to `Community 96`?**
  _High betweenness centrality (0.013) - this node is a cross-community bridge._
- **Why does `svelte` connect `Sentry Observability` to `Offline Log Queue (IndexedDB)`?**
  _High betweenness centrality (0.013) - this node is a cross-community bridge._
