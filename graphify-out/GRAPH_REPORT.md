# Graph Report - diversif  (2026-06-11)

## Corpus Check
- 449 files · ~364,101 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4455 nodes · 9555 edges · 167 communities (152 shown, 15 thin omitted)
- Extraction: 93% EXTRACTED · 7% INFERRED · 0% AMBIGUOUS · INFERRED: 712 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `51b1e1d0`
...
1. `languageTag()` - 524 edges
2. `testDb` - 61 edges
3. `makeRouteEvent()` - 53 edges
...
Cohesion: 0.01
Nodes (340): addSymptomLabel(), addSymptomNote(), addSymptomObservedAt(), addSymptomSeveritySevereSrPrefix(), aideNavLabel(), aideSharingBody(), aideSharingTitle(), aideSourcesCta() (+332 more)

### Community 1 - "i18n Messages (chrome.*)"
Cohesion: 0.01
Nodes (175): addSymptomNotePlaceholder(), addSymptomSubmit(), addSymptomTitle(), allergenDialogFirstSignsTitle(), allergenDialogHowToOfferTitle(), allergenDialogSeverityMajor(), allergenDialogSourcesTitle(), aujourdhuiAllergensFading() (+167 more)

### Community 2 - "i18n Messages (errors+log+landing)"
Cohesion: 0.01
Nodes (175): addSymptomNotePlaceholder(), addSymptomObservedAt(), allergenDialogBadgeFromMonths(), allergenDialogClose(), allergenDialogFirstSignsTitle(), allergenDialogSevereSignsTitle(), allergenDialogSeverityMajor(), allergenDialogSourcesTitle() (+167 more)

### Community 3 - "Page Loaders & Form Actions"
Cohesion: 0.01
Nodes (174): addSymptomNote(), addSymptomObservedAt(), addSymptomSubmit(), addSymptomTitle(), allergenDialogHowToOfferTitle(), allergenDialogSevereSignsTitle(), allergenDialogSourcesTitle(), allergenDialogTitle() (+166 more)

### Community 4 - "Test Fixtures & Setup Helpers"
Cohesion: 0.01
Nodes (132): allergenDialogBadgeFromMonths(), allergenDialogSeverityMajor(), aujourdhuiAllergensOk(), aujourdhuiAllergensTodo(), aujourdhuiBilanStreakRecord(), aujourdhuiRecentEmptyBody(), aujourdhuiRecentEmptyCta(), aujourdhuiRecentTitle() (+124 more)

### Community 5 - "Branding, App Shell & PWA Manifest"
Cohesion: 0.01
Nodes (131): addSymptomLabel(), addSymptomSeveritySevereSrPrefix(), addSymptomSubmit(), aujourdhuiRecentEmptyCta(), authAccountDeleteConfirmLabel(), authAccountDeletePasswordLabel(), authAccountDeleteSubmit(), authAccountDisplayNameLabel() (+123 more)

### Community 6 - "Architecture Patterns & Conventions"
Cohesion: 0.01
Nodes (194): addSymptomLabel(), addSymptomNotePlaceholder(), addSymptomSeveritySevereSrPrefix(), allergenDialogClose(), allergenDialogFirstSignsTitle(), allergenPassportFadingHint, allergenPassportSectionOther, allergenPassportSectionPriority (+186 more)

### Community 7 - "Auth Routes & i18n Routing"
Cohesion: 0.01
Nodes (194): addSymptomNote(), addSymptomTitle(), allergenDialogHowToOfferTitle(), allergenDialogTitle(), allergenPassportFadingHint, allergenPassportSectionOther, allergenPassportSectionPriority, allergenPassportStateCleared (+186 more)

### Community 8 - "UI Components & Tests"
Cohesion: 0.07
Nodes (53): load(), foodEntries, foods, symptoms, makeDeleteEvent(), makeFormEvent(), setup(), exportSpy (+45 more)

### Community 9 - "WebAuthn / Passkeys"
Cohesion: 0.05
Nodes (6): foods, user, ./$types, page, setPagePathname(), textSnippet()

### Community 10 - "Offline Log Queue (IndexedDB)"
Cohesion: 0.08
Nodes (20): @simplewebauthn/browser, svelte/elements, $app/environment, $app/forms, $app/navigation, $lib/forms/tracked-enhance, $lib/i18n, $lib/offline/uuid (+12 more)

### Community 11 - "User Memory & Medical Audit"
Cohesion: 0.05
Nodes (53): ALLERGEN_GUIDANCE, AllergenGuidance, APPROACHES, BentoStage, CATEGORY_GUIDANCE, CategoryGuidance, CHOKING_HAZARDS, ChokingHazard (+45 more)

### Community 12 - "SEO / JSON-LD Library"
Cohesion: 0.06
Nodes (43): load(), seed(), VALID_THEMES, Child, children, Food, FoodEntry, IdempotencyKey (+35 more)

### Community 13 - "UI Component Library"
Cohesion: 0.07
Nodes (49): Passkey, PASSKEY_AUTOFILL_OPTIONS_LIMIT, PASSKEY_OPTIONS_LIMIT, POST(), deleteSchema, load(), renameSchema, audit() (+41 more)

### Community 14 - "Account Export / Delete"
Cohesion: 0.07
Nodes (40): Session, User, actions, load(), seed(), seed(), actions, load() (+32 more)

### Community 15 - "DB Init, Backup & Seed"
Cohesion: 0.06
Nodes (13): filtered, baseClass, dayjs/locale/fr, $lib/paraglide/runtime, $lib/utils/age, $lib/utils/categories, $lib/utils/reactions, $lib/utils/search (+5 more)
...
Cohesion: 0.15
Nodes (29): db, GET(), load(), loadBentoAllergens(), loadWeeklyEntries(), load(), actions, AllergenSummary (+21 more)

### Community 18 - "Legal Pages"
Cohesion: 0.09
Nodes (26): actions, ActiveInvite, checkJoinInviteLookupLimit(), findActiveInvitation(), load(), userHasMembership(), hasUniqueShape(), isUniqueViolation() (+18 more)
...
Cohesion: 0.08
Nodes (20): #each(), introducedCount, other, stateIcon(), FRUITS, $lib/content/did-you-know, $lib/content/recipes, $lib/server/guidance/allergen-status (+12 more)

### Community 21 - "Diversification Guidance & Stages"
Cohesion: 0.1
Nodes (31): SEVERE, Severity, severityOf(), SYMPTOM_LABELS, SymptomLabel, WARN, countNthExposition(), deleteSymptomById() (+23 more)

### Community 22 - "UI Primitives & LEAP/EAT Cards"
Cohesion: 0.15
Nodes (8): sources, $lib/content/guidance, $lib/content/sources, $lib/seo, $lib/utils/allergens, ./$types, Icon, string
...
Cohesion: 0.1
Nodes (24): idempotencyKeys, webauthnChallenges, makeAutofillEvent(), makeModalEvent(), CleanupResult, runCleanup(), startCleanupTimer(), stopCleanupTimer() (+16 more)
...
Cohesion: 0.13
Nodes (20): SAMPLE, SAMPLE, FACT_CARDS, FactCard, getAllStagesForBento(), getStageForAgeMonths(), StageId, getRecipesForStage() (+12 more)
...
Cohesion: 0.08
Nodes (16): FULL_TWELVE, drizzleDb, pool, sqlite, AnyDb, applySeedCorrections(), FOODS_SEED, SeedFood (+8 more)
...
Cohesion: 0.09
Nodes (5): baseProps, $lib/content/symptoms, $lib/types, $lib/utils/monitor-timer, ./$types

### Community 41 - "Community 41"
Cohesion: 0.14
Nodes (19): getSeasonalNames(), SEASONAL_FOODS_BY_MONTH, execRows(), Executor, dismissReminder(), loadDismissals(), ttlForReminderKey(), DiversityMetrics (+11 more)

### Community 42 - "Community 42"
Cohesion: 0.08
Nodes (26): autoincrement, name, notNull, primaryKey, type, backed_up, device_type, public_key (+18 more)
...
Cohesion: 0.13
Nodes (6): i18n, $lib/utils/cn, $lib/utils/dates, reroute, cn(), localizedHref()
...
Cohesion: 0.17
Nodes (13): filterIncomingBreadcrumb(), ScrubbableEvent, scrubEvent(), scrubPathname(), scrubUrlString(), enforceLanguageTag(), isAvailableLanguageTag(), onSetLanguageTag() (+5 more)
...
Cohesion: 0.15
Nodes (14): Stage, resolveMessageKey(), trackSubmission(), AllergenReportRow, ReportEntry, ReportFood, $lib/paraglide/messages.js, getTextureLabel() (+6 more)
...
Cohesion: 0.14
Nodes (11): actions, load(), profileSchema, seed(), ./$types, fail(), parseForm(), ParseFormResult (+3 more)
...
Cohesion: 0.18
Nodes (10): Membership, ChildSummary, RecentEntry, SafeUser, SymptomEntry, ./$types, load(), parseChildIdParamOrNull() (+2 more)

### Community 70 - "Community 70"
Cohesion: 0.17
Nodes (14): Executor, ResolveFoodInput, ResolveFoodResult, resolveOrInsertFood(), CATEGORY_IDS, CATEGORY_LABEL_RESOLVERS, CategoryClasses, CategoryColor (+6 more)
...
- **Why does `languageTag()` connect `i18n Messages (auth.*)` to `Community 48`, `i18n Messages (chrome.*)`, `Community 101`, `Community 45`?**
  _High betweenness centrality (0.085) - this node is a cross-community bridge._
- **Why does `localizedHref()` connect `Community 45` to `i18n Messages (auth.*)`, `Offline Log Queue (IndexedDB)`?**
  _High betweenness centrality (0.016) - this node is a cross-community bridge._
- **Why does `devDependencies` connect `Invitations & Memberships` to `Community 96`?**
  _High betweenness centrality (0.013) - this node is a cross-community bridge._
- **Are the 517 inferred relationships involving `languageTag()` (e.g. with `localizedHref()` and `formatRelative()`) actually correct?**
  _`languageTag()` has 517 INFERRED edges - model-reasoned connections that need verification._
