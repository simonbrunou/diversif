...
## Corpus Check
- 449 files · ~366,605 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4282 nodes · 8181 edges · 150 communities (136 shown, 14 thin omitted)
- Extraction: 91% EXTRACTED · 9% INFERRED · 0% AMBIGUOUS · INFERRED: 714 edges (avg confidence: 0.8)
...
## Communities (150 total, 14 thin omitted)

### Community 0 - "i18n Messages (auth.*)"
Cohesion: 0.01
Nodes (521): addSymptomLabel(), addSymptomNote(), addSymptomNotePlaceholder(), addSymptomObservedAt(), addSymptomSeveritySevereSrPrefix(), addSymptomSubmit(), addSymptomTitle(), aideNavLabel() (+513 more)

### Community 1 - "i18n Messages (chrome.*)"
Cohesion: 0.01
Nodes (284): addSymptomNotePlaceholder(), addSymptomSeveritySevereSrPrefix(), addSymptomSubmit(), addSymptomTitle(), allergenDialogClose(), allergenDialogFirstSignsTitle(), allergenDialogSevereSignsTitle(), allergenDialogSourcesTitle() (+276 more)

### Community 2 - "i18n Messages (errors+log+landing)"
Cohesion: 0.01
Nodes (212): addSymptomNote(), addSymptomNotePlaceholder(), addSymptomTitle(), allergenDialogBadgeFromMonths(), allergenDialogClose(), allergenDialogSourcesTitle(), aujourdhuiAllergensFading(), aujourdhuiAllergensTitle() (+204 more)

### Community 3 - "Page Loaders & Form Actions"
Cohesion: 0.01
Nodes (211): addSymptomLabel(), addSymptomNote(), addSymptomObservedAt(), allergenDialogBadgeFromMonths(), allergenDialogHowToOfferTitle(), allergenDialogSeverityMajor(), allergenDialogTitle(), aujourdhuiAllergensOk() (+203 more)

### Community 4 - "Test Fixtures & Setup Helpers"
Cohesion: 0.01
Nodes (283): addSymptomLabel(), addSymptomObservedAt(), addSymptomSeveritySevereSrPrefix(), addSymptomSubmit(), allergenDialogFirstSignsTitle(), allergenDialogHowToOfferTitle(), allergenDialogSevereSignsTitle(), allergenDialogSeverityMajor() (+275 more)
...
Cohesion: 0.05
Nodes (61): seed(), users, actions, load(), seed(), seed(), actions, load() (+53 more)

### Community 7 - "Auth Routes & i18n Routing"
Cohesion: 0.05
Nodes (52): getAllStagesForBento(), getStageForAgeMonths(), execRows(), Executor, db, drizzleDb, pool, sqlite (+44 more)

### Community 8 - "UI Components & Tests"
Cohesion: 0.06
Nodes (59): load(), VALID_THEMES, PASSKEY_AUTOFILL_OPTIONS_LIMIT, PASSKEY_OPTIONS_LIMIT, POST(), deleteSchema, load(), renameSchema (+51 more)
...
Cohesion: 0.05
Nodes (14): baseProps, ../app.css, $lib/content/symptoms, $lib/i18n, $lib/offline/queue, $lib/paraglide/messages, $lib/paraglide/runtime, $lib/types (+6 more)

### Community 12 - "SEO / JSON-LD Library"
Cohesion: 0.05
Nodes (38): dependencies, clsx, dayjs, drizzle-orm, @fontsource-variable/fraunces, @fontsource-variable/inter, @inlang/paraglide-js, lucide-svelte (+30 more)

### Community 13 - "UI Component Library"
Cohesion: 0.1
Nodes (11): sources, $lib/content/guidance, $lib/content/sources, $lib/seo, $lib/utils/age, $lib/utils/allergens, $lib/utils/localized-href, $lib/utils/milestones (+3 more)

### Community 14 - "Account Export / Delete"
Cohesion: 0.1
Nodes (40): countNthExposition(), listSymptomsByEntry(), addSchema, formatDate(), formatTime(), load(), loadEntry(), loadEntryForChild() (+32 more)
...
Cohesion: 0.09
Nodes (25): SEVERE, Severity, severityOf(), SYMPTOM_LABELS, SymptomLabel, WARN, Membership, symptoms (+17 more)
...
Cohesion: 0.06
Nodes (32): autoincrement, name, notNull, primaryKey, type, backed_up, device_type, last_used_at (+24 more)
...
Cohesion: 0.09
Nodes (19): bits-ui, ./use-bottom-sheet-drag.svelte, drag, findScrollable(), handleOpenChange(), isDesktop, isInteractive(), onSheetPointerCancel() (+11 more)
...
Cohesion: 0.11
Nodes (7): filtered, baseClass, $lib/utils/categories, $lib/utils/cn, $lib/utils/reactions, $lib/utils/search, $lib/utils/texture-labels
...
Cohesion: 0.11
Nodes (23): ALLERGEN_GUIDANCE, AllergenGuidance, APPROACHES, BentoStage, CATEGORY_GUIDANCE, CategoryGuidance, CHOKING_HAZARDS, ChokingHazard (+15 more)
...
Cohesion: 0.1
Nodes (8): streakLabel, $lib/paraglide/messages.js, $lib/server/guidance/allergen-status, $lib/server/guidance/reminders, $lib/utils/suggest, SuggestFood, getTextureLabel(), LABEL_FNS
...
Cohesion: 0.17
Nodes (14): actions, ActiveInvite, checkJoinInviteLookupLimit(), findActiveInvitation(), load(), userHasMembership(), hasUniqueShape(), isUniqueViolation() (+6 more)
...
Cohesion: 0.5
Nodes (3): ALL_SOURCE_IDS, Source, SourceId
...
- **Why does `languageTag()` connect `i18n Messages (auth.*)` to `Community 33`, `SEO / JSON-LD Library`?**
  _High betweenness centrality (0.083) - this node is a cross-community bridge._
- **Why does `localizedHref()` connect `Community 33` to `i18n Messages (auth.*)`, `Sentry Observability`?**
  _High betweenness centrality (0.018) - this node is a cross-community bridge._
- **Why does `setLanguageTag()` connect `SEO / JSON-LD Library` to `i18n Messages (auth.*)`, `Community 33`?**
  _High betweenness centrality (0.006) - this node is a cross-community bridge._
- **Are the 523 inferred relationships involving `languageTag()` (e.g. with `formatRelative()` and `formatMonthsSince()`) actually correct?**
  _`languageTag()` has 523 INFERRED edges - model-reasoned connections that need verification._
