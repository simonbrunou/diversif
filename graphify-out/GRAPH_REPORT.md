...
## Corpus Check
- 460 files · ~419,968 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4450 nodes · 9026 edges · 165 communities (150 shown, 15 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 193 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `10e80148`
...
Cohesion: 0.01
Nodes (242): addSymptomLabel(), addSymptomNote(), addSymptomNotePlaceholder(), addSymptomSubmit(), allergenDialogFirstSignsTitle(), allergenDialogHowToOfferTitle(), allergenDialogSevereSignsTitle(), allergenDialogSeverityMajor() (+234 more)

### Community 1 - "i18n Messages (chrome.*)"
Cohesion: 0.01
Nodes (116): addSymptomObservedAt(), addSymptomTitle(), allergenDialogBadgeFromMonths(), allergenDialogClose(), allergenDialogSourcesTitle(), allergenDialogWhyEarlyTitle(), aujourdhuiAllergensFading(), aujourdhuiAllergensOk() (+108 more)

### Community 2 - "i18n Messages (errors+log+landing)"
Cohesion: 0.01
Nodes (175): addSymptomLabel(), addSymptomNote(), addSymptomTitle(), allergenDialogFirstSignsTitle(), allergenDialogHowToOfferTitle(), aujourdhuiAllergensFading(), aujourdhuiAllergensTodo(), aujourdhuiBilanStreak() (+167 more)

### Community 3 - "Page Loaders & Form Actions"
Cohesion: 0.01
Nodes (175): addSymptomNotePlaceholder(), addSymptomObservedAt(), addSymptomTitle(), allergenDialogBadgeFromMonths(), allergenDialogClose(), allergenDialogFirstSignsTitle(), allergenDialogSevereSignsTitle(), allergenDialogSeverityMajor() (+167 more)

### Community 4 - "Test Fixtures & Setup Helpers"
Cohesion: 0.01
Nodes (133): addSymptomNotePlaceholder(), addSymptomSeveritySevereSrPrefix(), addSymptomSubmit(), allergenDialogSevereSignsTitle(), allergenDialogTitle(), allergenDialogWhyEarlyTitle(), aujourdhuiBilanAliments(), aujourdhuiBilanStreakDaysOne() (+125 more)

### Community 5 - "Branding, App Shell & PWA Manifest"
Cohesion: 0.01
Nodes (132): addSymptomLabel(), addSymptomNote(), addSymptomSubmit(), allergenDialogHowToOfferTitle(), aujourdhuiAllergensTodo(), aujourdhuiBilanStreakRecord(), aujourdhuiRecentEmpty(), aujourdhuiRecentEmptyBody() (+124 more)

### Community 6 - "Architecture Patterns & Conventions"
Cohesion: 0.01
Nodes (193): addSymptomSeveritySevereSrPrefix(), allergenDialogSourcesTitle(), allergenPassportFadingHint, allergenPassportSectionOther, allergenPassportSectionPriority, allergenPassportStateCleared, allergenPassportStateFading, allergenPassportStateReaction (+185 more)

### Community 7 - "Auth Routes & i18n Routing"
Cohesion: 0.01
Nodes (192): addSymptomObservedAt(), allergenDialogBadgeFromMonths(), allergenDialogClose(), allergenDialogSeverityMajor(), allergenDialogSourcesTitle(), allergenPassportFadingHint, allergenPassportSectionOther, allergenPassportSectionPriority (+184 more)

### Community 8 - "UI Components & Tests"
Cohesion: 0.07
Nodes (54): seed(), load(), users, seed(), makeDeleteEvent(), makeFormEvent(), loadFor(), loadFor() (+46 more)

### Community 9 - "WebAuthn / Passkeys"
Cohesion: 0.07
Nodes (54): load(), VALID_THEMES, PASSKEY_AUTOFILL_OPTIONS_LIMIT, PASSKEY_OPTIONS_LIMIT, POST(), actions, deleteSchema, load() (+46 more)

### Community 10 - "Offline Log Queue (IndexedDB)"
Cohesion: 0.05
Nodes (48): db, drizzleDb, pool, sqlite, actions, load(), actions, load() (+40 more)

### Community 11 - "User Memory & Medical Audit"
Cohesion: 0.07
Nodes (50): countNthExposition(), listSymptomsByEntry(), addSchema, formatDate(), formatTime(), load(), loadEntry(), loadEntryForChild() (+42 more)
...
Cohesion: 0.08
Nodes (18): ../app.css, $lib/i18n, $lib/offline/queue, $lib/paraglide/messages, $lib/paraglide/runtime, $lib/seo, $lib/utils/localized-href, $lib/utils/milestones (+10 more)

### Community 15 - "DB Init, Backup & Seed"
Cohesion: 0.13
Nodes (26): foodEntries, foods, symptoms, deleteSymptomById(), insertSymptom(), InsertSymptomResult, setup(), setup() (+18 more)

### Community 16 - "Allergens & Milestones"
Cohesion: 0.07
Nodes (17): #each(), introducedCount, other, stateIcon(), FULL_TWELVE, FRUITS, $lib/content/did-you-know, $lib/content/recipes (+9 more)
...
Cohesion: 0.13
Nodes (9): @simplewebauthn/browser, svelte/elements, $app/environment, $app/forms, $app/navigation, $lib/forms/tracked-enhance, $lib/offline/uuid, $lib/utils/dates (+1 more)
...
Cohesion: 0.11
Nodes (27): getSeasonalNames(), SEASONAL_FOODS_BY_MONTH, execRows(), Executor, actions, AllergenSummary, load(), dismissReminder() (+19 more)
...
Cohesion: 0.1
Nodes (24): actions, ActiveInvite, checkJoinInviteLookupLimit(), findActiveInvitation(), load(), userHasMembership(), hasUniqueShape(), isUniqueViolation() (+16 more)
...
Cohesion: 0.06
Nodes (31): autoincrement, name, notNull, primaryKey, type, autoincrement, name, notNull (+23 more)
...
Cohesion: 0.08
Nodes (4): baseProps, $lib/content/symptoms, $lib/types, $lib/utils/texture-labels
...
Cohesion: 0.12
Nodes (16): Stage, resolveMessageKey(), trackSubmission(), AllergenReportRow, load(), ReportEntry, ReportFood, $lib/paraglide/messages.js (+8 more)
...
Cohesion: 0.21
Nodes (14): dayjs/locale/fr, enforceLanguageTag(), isAvailableLanguageTag(), languageTag(), onSetLanguageTag(), setLanguageTag(), formatDateInputValue(), formatDateTime() (+6 more)

### Community 66 - "Community 66"
Cohesion: 0.16
Nodes (14): SEVERE, Severity, severityOf(), SYMPTOM_LABELS, SymptomLabel, WARN, Membership, User (+6 more)
...
Cohesion: 0.26
Nodes (12): getAllStagesForBento(), getStageForAgeMonths(), getRecipesForStage(), loadAllergenStatus(), load(), loadSeasonalFoods(), loadTextureProgress(), ./$types (+4 more)
...
Cohesion: 0.19
Nodes (7): listMembershipsForUser(), handle(), handleError(), resolveLocaleFromRequest(), { captureExceptionMock, initMock }, CookieOpts, { setLanguageTagMock }
...
Cohesion: 0.18
Nodes (4): $lib/utils/age, $lib/utils/categories, $lib/utils/reactions, $lib/utils/search
...
Cohesion: 0.3
Nodes (5): filterIncomingBreadcrumb(), ScrubbableEvent, scrubEvent(), scrubPathname(), scrubUrlString()
...
- **Why does `languageTag()` connect `Community 65` to `Community 48`, `i18n Messages (chrome.*)`, `i18n Messages (auth.*)`?**
  _High betweenness centrality (0.078) - this node is a cross-community bridge._
- **Why does `devDependencies` connect `Invitations & Memberships` to `Community 99`?**
  _High betweenness centrality (0.013) - this node is a cross-community bridge._
- **Why does `svelte` connect `Invitations & Memberships` to `UI Component Library`?**
  _High betweenness centrality (0.013) - this node is a cross-community bridge._
