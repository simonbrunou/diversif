...
## Summary
- 4443 nodes · 9020 edges · 164 communities (149 shown, 15 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 193 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `0f18d864`
...
Cohesion: 0.01
Nodes (241): addSymptomLabel(), addSymptomNote(), addSymptomNotePlaceholder(), allergenDialogClose(), allergenDialogFirstSignsTitle(), allergenDialogHowToOfferTitle(), allergenDialogSevereSignsTitle(), allergenDialogSourcesTitle() (+233 more)

### Community 1 - "i18n Messages (chrome.*)"
Cohesion: 0.01
Nodes (117): addSymptomObservedAt(), addSymptomSubmit(), addSymptomTitle(), allergenDialogBadgeFromMonths(), allergenDialogSeverityMajor(), aujourdhuiAllergensFading(), aujourdhuiBilanAliments(), aujourdhuiBilanStreakDaysOne() (+109 more)

### Community 2 - "i18n Messages (errors+log+landing)"
Cohesion: 0.01
Nodes (175): addSymptomLabel(), addSymptomObservedAt(), addSymptomSubmit(), addSymptomTitle(), allergenDialogHowToOfferTitle(), allergenDialogSevereSignsTitle(), aujourdhuiAllergensFading(), aujourdhuiAllergensOk() (+167 more)

### Community 3 - "Page Loaders & Form Actions"
Cohesion: 0.01
Nodes (175): addSymptomLabel(), addSymptomNote(), addSymptomSubmit(), allergenDialogSevereSignsTitle(), allergenDialogSourcesTitle(), aujourdhuiAllergensFading(), aujourdhuiAllergensOk(), aujourdhuiAllergensTitle() (+167 more)

### Community 4 - "Test Fixtures & Setup Helpers"
Cohesion: 0.01
Nodes (133): addSymptomSeveritySevereSrPrefix(), addSymptomTitle(), allergenDialogBadgeFromMonths(), allergenDialogSeverityMajor(), aujourdhuiBilanAliments(), aujourdhuiBilanStreakDaysOne(), aujourdhuiBilanStreakRecord(), aujourdhuiRecentEmptyCta() (+125 more)

### Community 5 - "Branding, App Shell & PWA Manifest"
Cohesion: 0.01
Nodes (196): addSymptomNote(), addSymptomNotePlaceholder(), addSymptomSeveritySevereSrPrefix(), allergenDialogFirstSignsTitle(), allergenDialogSeverityMajor(), allergenDialogSourcesTitle(), allergenPassportFadingHint, allergenPassportSectionOther (+188 more)

### Community 6 - "Architecture Patterns & Conventions"
Cohesion: 0.01
Nodes (129): allergenDialogBadgeFromMonths(), allergenDialogClose(), allergenDialogTitle(), allergenDialogWhyEarlyTitle(), aujourdhuiAllergensTitle(), aujourdhuiBilanAliments(), aujourdhuiBilanStreakRecord(), aujourdhuiRecentEmptyBody() (+121 more)

### Community 7 - "Auth Routes & i18n Routing"
Cohesion: 0.01
Nodes (192): addSymptomNotePlaceholder(), addSymptomObservedAt(), allergenDialogClose(), allergenDialogFirstSignsTitle(), allergenDialogHowToOfferTitle(), allergenDialogTitle(), allergenDialogWhyEarlyTitle(), allergenPassportFadingHint (+184 more)
...
Cohesion: 0.05
Nodes (68): seed(), VALID_THEMES, users, actions, load(), seed(), seed(), actions (+60 more)

### Community 10 - "Offline Log Queue (IndexedDB)"
Cohesion: 0.05
Nodes (58): Child, children, Food, FoodEntry, IdempotencyKey, idempotencyKeys, Invitation, invitations (+50 more)

### Community 11 - "User Memory & Medical Audit"
Cohesion: 0.07
Nodes (55): SEVERE, Severity, severityOf(), SYMPTOM_LABELS, SymptomLabel, WARN, db, drizzleDb (+47 more)

### Community 12 - "SEO / JSON-LD Library"
Cohesion: 0.08
Nodes (25): @simplewebauthn/browser, $app/environment, $app/forms, $app/navigation, $lib/forms/tracked-enhance, $lib/i18n, $lib/offline/uuid, $lib/paraglide/messages (+17 more)

### Community 13 - "UI Component Library"
Cohesion: 0.07
Nodes (51): load(), PASSKEY_AUTOFILL_OPTIONS_LIMIT, PASSKEY_OPTIONS_LIMIT, POST(), actions, deleteSchema, load(), renameSchema (+43 more)
...
Cohesion: 0.06
Nodes (12): filtered, baseClass, FRUITS, svelte/elements, $lib/paraglide/runtime, $lib/utils/categories, $lib/utils/cn, $lib/utils/reactions (+4 more)
...
Cohesion: 0.11
Nodes (26): getSeasonalNames(), SEASONAL_FOODS_BY_MONTH, execRows(), Executor, actions, AllergenSummary, load(), dismissReminder() (+18 more)

### Community 19 - "Invitations & Memberships"
Cohesion: 0.09
Nodes (27): categoryLabel(), computeReminders(), push(), Reminder, ReminderInput, Severity, SEVERITY_RANK, ALL_ALLERGENS (+19 more)
...
Cohesion: 0.08
Nodes (6): baseProps, $lib/content/symptoms, $lib/types, $lib/utils/monitor-timer, $lib/utils/texture-labels, ./$types
...
Cohesion: 0.14
Nodes (18): SAMPLE, getAllStagesForBento(), getStageForAgeMonths(), StageId, getRecipesForStage(), Recipe, RECIPES, loadAllergenStatus() (+10 more)
...
Cohesion: 0.1
Nodes (16): #each(), introducedCount, other, stateIcon(), $lib/content/did-you-know, $lib/content/recipes, $lib/paraglide/messages.js, $lib/server/guidance/allergen-status (+8 more)
...
Cohesion: 0.07
Nodes (27): counter, last_used_at, public_key, transports, autoincrement, default, name, notNull (+19 more)
...
Cohesion: 0.1
Nodes (8): ../app.css, $lib/offline/queue, $lib/utils/dates, $lib/utils/theme, bentoKids, firstChildId, isAccountRoute, locale
...
Cohesion: 0.12
Nodes (16): lint-staged, *.{json,md,css,html}, *.{ts,js,svelte}, name, overrides, cookie, devalue, esbuild (+8 more)
...
Cohesion: 0.19
Nodes (11): Membership, User, ChildSummary, RecentEntry, SafeUser, SymptomEntry, ./$types, load() (+3 more)
...
- **Why does `languageTag()` connect `Community 37` to `Community 64`, `i18n Messages (chrome.*)`, `i18n Messages (auth.*)`, `Community 95`?**
  _High betweenness centrality (0.084) - this node is a cross-community bridge._
- **Why does `devDependencies` connect `Sentry Observability` to `Community 70`?**
  _High betweenness centrality (0.013) - this node is a cross-community bridge._
- **Why does `svelte` connect `Sentry Observability` to `Account Export / Delete`?**
  _High betweenness centrality (0.013) - this node is a cross-community bridge._
