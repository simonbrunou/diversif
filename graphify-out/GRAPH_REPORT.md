...
## Corpus Check
- 458 files · ~414,987 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4403 nodes · 8968 edges · 165 communities (151 shown, 14 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 192 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `112defa7`
...
- `seed()` --calls--> `hashPassword()`  [INFERRED]
  src/routes/account/passkeys/page.server.test.ts → src/lib/server/auth.ts

## Communities (165 total, 14 thin omitted)

### Community 0 - "i18n Messages (auth.*)"
Cohesion: 0.01
Nodes (235): addSymptomNote(), addSymptomNotePlaceholder(), addSymptomSubmit(), addSymptomTitle(), allergenDialogBadgeFromMonths(), allergenDialogClose(), allergenDialogFirstSignsTitle(), allergenDialogHowToOfferTitle() (+227 more)

### Community 1 - "i18n Messages (chrome.*)"
Cohesion: 0.01
Nodes (123): addSymptomLabel(), addSymptomObservedAt(), allergenDialogSourcesTitle(), aujourdhuiBilanAliments(), aujourdhuiBilanStreakRecord(), aujourdhuiRecentEmpty(), authAccountDeleteConfirmLabel(), authAccountDeleteDescription() (+115 more)

### Community 2 - "i18n Messages (errors+log+landing)"
Cohesion: 0.01
Nodes (172): addSymptomLabel(), addSymptomNote(), allergenDialogClose(), allergenDialogFirstSignsTitle(), allergenDialogSevereSignsTitle(), aujourdhuiAllergensFading(), aujourdhuiAllergensTodo(), aujourdhuiBilanAliments() (+164 more)

### Community 3 - "Page Loaders & Form Actions"
Cohesion: 0.01
Nodes (171): addSymptomLabel(), addSymptomNote(), addSymptomSubmit(), addSymptomTitle(), allergenDialogHowToOfferTitle(), allergenDialogSourcesTitle(), allergenDialogTitle(), allergenDialogWhyEarlyTitle() (+163 more)

### Community 4 - "Test Fixtures & Setup Helpers"
Cohesion: 0.01
Nodes (140): allergenDialogBadgeFromMonths(), allergenDialogFirstSignsTitle(), allergenDialogSeverityMajor(), aujourdhuiAllergensFading(), aujourdhuiAllergensTitle(), aujourdhuiAllergensTodo(), aujourdhuiBilanAliments(), aujourdhuiBilanStreak() (+132 more)

### Community 5 - "Branding, App Shell & PWA Manifest"
Cohesion: 0.01
Nodes (190): addSymptomNotePlaceholder(), addSymptomObservedAt(), addSymptomSeveritySevereSrPrefix(), addSymptomSubmit(), allergenDialogBadgeFromMonths(), allergenDialogHowToOfferTitle(), allergenDialogWhyEarlyTitle(), allergenPassportFadingHint (+182 more)

### Community 6 - "Architecture Patterns & Conventions"
Cohesion: 0.01
Nodes (189): addSymptomNotePlaceholder(), addSymptomObservedAt(), addSymptomSeveritySevereSrPrefix(), allergenDialogClose(), allergenDialogSevereSignsTitle(), allergenPassportFadingHint, allergenPassportSectionOther, allergenPassportSectionPriority (+181 more)

### Community 7 - "Auth Routes & i18n Routing"
Cohesion: 0.01
Nodes (138): addSymptomTitle(), allergenDialogSeverityMajor(), allergenDialogSourcesTitle(), allergenDialogTitle(), aujourdhuiAllergensTitle(), aujourdhuiRecentEmptyCta(), authAccountAppearanceSection(), authAccountDeleteDescription() (+130 more)

### Community 8 - "UI Components & Tests"
Cohesion: 0.08
Nodes (49): load(), foodEntries, foods, symptoms, makeDeleteEvent(), makeFormEvent(), setup(), exportSpy (+41 more)

### Community 9 - "WebAuthn / Passkeys"
Cohesion: 0.05
Nodes (52): seed(), Session, actions, load(), seed(), seed(), actions, load() (+44 more)

### Community 10 - "Offline Log Queue (IndexedDB)"
Cohesion: 0.06
Nodes (54): Child, children, Food, FoodEntry, IdempotencyKey, idempotencyKeys, Invitation, invitations (+46 more)
...
Cohesion: 0.08
Nodes (42): load(), VALID_THEMES, db, drizzleDb, pool, sqlite, loadEntry(), schema (+34 more)
...
Cohesion: 0.06
Nodes (11): baseProps, $lib/content/symptoms, $lib/i18n, $lib/paraglide/messages, $lib/types, $lib/utils/age, $lib/utils/localized-href, $lib/utils/milestones (+3 more)

### Community 15 - "DB Init, Backup & Seed"
Cohesion: 0.06
Nodes (25): #each(), introducedCount, other, stateIcon(), filtered, baseClass, FRUITS, $lib/content/did-you-know (+17 more)

### Community 16 - "Allergens & Milestones"
Cohesion: 0.09
Nodes (35): SEVERE, Severity, severityOf(), SYMPTOM_LABELS, SymptomLabel, WARN, countNthExposition(), deleteSymptomById() (+27 more)
...
Cohesion: 0.07
Nodes (32): SAMPLE, SAMPLE, FACT_CARDS, FactCard, ALLERGEN_GUIDANCE, AllergenGuidance, APPROACHES, BentoStage (+24 more)

### Community 19 - "Invitations & Memberships"
Cohesion: 0.07
Nodes (31): Stage, AnyDb, applySeedCorrections(), FOODS_SEED, SeedFood, seedFoods(), Tx, resolveMessageKey() (+23 more)
...
Cohesion: 0.09
Nodes (28): categoryLabel(), computeReminders(), push(), Reminder, ReminderInput, Severity, SEVERITY_RANK, ALL_ALLERGENS (+20 more)
...
Cohesion: 0.08
Nodes (20): actions, deleteSchema, renameSchema, auditSpy, seed(), actions, load(), profileSchema (+12 more)
...
Cohesion: 0.13
Nodes (20): execRows(), Executor, actions, AllergenSummary, dismissReminder(), loadDismissals(), ttlForReminderKey(), DiversityMetrics (+12 more)
...
Cohesion: 0.07
Nodes (27): invitations_child_id_children_id_fk, invitations_used_by_users_id_fk, invitations_expires_at_idx, checkConstraints, columnsFrom, columnsTo, name, onDelete (+19 more)
...
Cohesion: 0.17
Nodes (17): getAllStagesForBento(), getStageForAgeMonths(), getRecipesForStage(), getSeasonalNames(), SEASONAL_FOODS_BY_MONTH, loadAllergenStatus(), load(), loadSeasonalFoods() (+9 more)

### Community 47 - "Community 47"
Cohesion: 0.12
Nodes (17): makeAutofillEvent(), makeModalEvent(), ./$types, fakeUser, requireGuest(), Bucket, bucketKey(), _clearAllRateLimits() (+9 more)
...
Cohesion: 0.19
Nodes (10): filterIncomingBreadcrumb(), ScrubbableEvent, scrubEvent(), scrubPathname(), scrubUrlString(), enforceLanguageTag(), isAvailableLanguageTag(), languageTag() (+2 more)

### Community 56 - "Community 56"
Cohesion: 0.16
Nodes (11): FULL_TWELVE, load(), loadBentoAllergens(), loadWeeklyEntries(), AllergenItem, PRIORITY_SET, loadRepeatCandidates(), loadTexturesTried() (+3 more)
...
Cohesion: 0.27
Nodes (8): Membership, User, ChildSummary, RecentEntry, SafeUser, SymptomEntry, load(), Locals
...
- **Why does `languageTag()` connect `Community 55` to `Allergens & Milestones`, `i18n Messages (chrome.*)`, `Diversity Metrics`, `i18n Messages (auth.*)`?**
  _High betweenness centrality (0.080) - this node is a cross-community bridge._
- **Why does `handleOnline()` connect `Community 37` to `Community 68`?**
