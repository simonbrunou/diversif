...
## Summary
- 4251 nodes · 7997 edges · 154 communities (136 shown, 18 thin omitted)
- Extraction: 91% EXTRACTED · 9% INFERRED · 0% AMBIGUOUS · INFERRED: 707 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `ec071c15`
...
Cohesion: 0.01
Nodes (215): addSymptomNote(), addSymptomNotePlaceholder(), addSymptomSeveritySevereSrPrefix(), addSymptomSubmit(), allergenDialogBadgeFromMonths(), allergenDialogFirstSignsTitle(), allergenDialogHowToOfferTitle(), allergenDialogSevereSignsTitle() (+207 more)

### Community 2 - "Community 2"
Cohesion: 0.01
Nodes (215): addSymptomNote(), addSymptomNotePlaceholder(), addSymptomObservedAt(), addSymptomTitle(), allergenDialogHowToOfferTitle(), allergenDialogSeverityMajor(), allergenDialogWhyEarlyTitle(), aujourdhuiAllergensTitle() (+207 more)

### Community 3 - "Community 3"
Cohesion: 0.01
Nodes (280): addSymptomLabel(), addSymptomObservedAt(), addSymptomTitle(), allergenDialogClose(), allergenDialogSourcesTitle(), allergenDialogWhyEarlyTitle(), allergenPassportFadingHint, allergenPassportSectionOther (+272 more)

### Community 4 - "Community 4"
Cohesion: 0.01
Nodes (280): addSymptomLabel(), addSymptomSeveritySevereSrPrefix(), addSymptomSubmit(), allergenDialogBadgeFromMonths(), allergenDialogClose(), allergenDialogFirstSignsTitle(), allergenDialogSevereSignsTitle(), allergenDialogSourcesTitle() (+272 more)

### Community 5 - "Community 5"
Cohesion: 0.06
Nodes (70): seed(), load(), seed(), makeDeleteEvent(), makeFormEvent(), setup(), loadFor(), setup() (+62 more)

### Community 6 - "Community 6"
Cohesion: 0.05
Nodes (57): actions, ActiveInvite, checkJoinInviteLookupLimit(), findActiveInvitation(), load(), userHasMembership(), hasUniqueShape(), isUniqueViolation() (+49 more)

### Community 7 - "Community 7"
Cohesion: 0.06
Nodes (58): SEVERE, Severity, severityOf(), SYMPTOM_LABELS, SymptomLabel, WARN, Membership, symptoms (+50 more)
...
Cohesion: 0.06
Nodes (6): foods, user, page, setPagePathname(), stubGlobal(), textSnippet()
...
Cohesion: 0.11
Nodes (6): baseProps, @simplewebauthn/browser, svelte/elements, $app/environment, $app/forms, $app/navigation
...
Cohesion: 0.11
Nodes (4): $lib/paraglide/messages, $app/state, Icon, string
...
Cohesion: 0.1
Nodes (14): filterIncomingBreadcrumb(), ScrubbableEvent, scrubEvent(), scrubPathname(), scrubUrlString(), setLanguageTag(), invalidateSession(), listMembershipsForUser() (+6 more)
...
Cohesion: 0.1
Nodes (26): ALLERGEN_GUIDANCE, AllergenGuidance, APPROACHES, BentoStage, CATEGORY_GUIDANCE, CategoryGuidance, CHOKING_HAZARDS, ChokingHazard (+18 more)
...
Cohesion: 0.1
Nodes (17): drag, findScrollable(), handleOpenChange(), isDesktop, isInteractive(), onSheetPointerCancel(), onSheetPointerDown(), onSheetPointerMove() (+9 more)
...
Cohesion: 0.13
Nodes (16): idempotencyKeys, LogActionAbort, schema, Executor, ResolveFoodInput, ResolveFoodResult, resolveOrInsertFood(), IdempotencyInFlight (+8 more)
...
Cohesion: 0.12
Nodes (5): ../app.css, bentoKids, firstChildId, isAccountRoute, locale
...
## Knowledge Gaps
- **1430 isolated node(s):** `name`, `version`, `private`, `type`, `_bun_invocation_note` (+1425 more)
...
- **Why does `languageTag()` connect `Community 0` to `Community 40`, `Community 8`, `Community 22`?**
  _High betweenness centrality (0.079) - this node is a cross-community bridge._
- **Why does `localizedHref()` connect `Community 40` to `Community 0`, `Community 12`?**
  _High betweenness centrality (0.014) - this node is a cross-community bridge._
- **Why does `handleOnline()` connect `Community 34` to `Community 60`?**
