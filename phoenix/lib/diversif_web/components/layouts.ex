defmodule DiversifWeb.Layouts do
  @moduledoc """
  This module holds layouts and related functionality
  used by your application.
  """
  use DiversifWeb, :html
  ...
  attr :current_user, :map, default: nil, doc: "current authenticated user, or nil"
  attr :wide, :boolean, default: false, doc: "use a wider main container"
  slot :inner_block, required: true

  def app(assigns) do
    ~H"""
    <header class="border-b border-zinc-200">
      <div class="mx-auto max-w-5xl flex items-center justify-between px-4 sm:px-6 py-3">
