...
const INFANT_DAY: { id: MealId; roles: RoleId[] }[] = [
  { id: 'midi', roles: ['legume', 'proteine', 'feculent', 'matiereGrasse', 'dessert'] },
  { id: 'gouter', roles: ['fruit'] },
  { id: 'soir', roles: ['legume', 'feculent'] }
];

const TODDLER_DAY: { id: MealId; roles: RoleId[] }[] = [
  { id: 'matin', roles: ['fruit', 'feculent'] },
  { id: 'midi', roles: ['legume', 'proteine', 'feculent', 'matiereGrasse', 'dessert'] },
  { id: 'gouter', roles: ['fruit', 'feculent'] },
...
export const SOFT_CHEESE = [
  'Camembert pasteurisé',
  'Chèvre frais pasteurisé',
  'Fromage de brebis pasteurisé'
];
...
export const CHOKING_BY_FOOD: Record<string, string> = {
  ...
  Myrtille: 'Écraser ou aplatir (baie ronde).',
  Cassis: 'Écraser ou aplatir (baie ronde).'
};
